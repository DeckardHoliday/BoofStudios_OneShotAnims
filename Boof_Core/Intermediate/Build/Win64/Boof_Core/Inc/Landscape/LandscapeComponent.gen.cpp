...
static struct FScriptStruct_Landscape_StaticRegisterNativesFLandscapeEditToolRenderData
{
	...
	UFunction* Z_Construct_UFunction_ULandscapeComponent_GetMaterialInstanceDynamic()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Object, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000580, 1, nullptr, STRUCT_OFFSET(LandscapeComponent_eventGetMaterialInstanceDynamic_Parms, ReturnValue), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_InIndex = { UE4CodeGen_Private::EPropertyClass::Int, "InIndex", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(LandscapeComponent_eventGetMaterialInstanceDynamic_Parms, InIndex), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	UClass* Z_Construct_UClass_ULandscapeComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ULandscapeComponent_GetMaterialInstanceDynamic, "GetMaterialInstanceDynamic" }, // 383376176
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_MaterialInstancesDynamic = { UE4CodeGen_Private::EPropertyClass::Array, "MaterialInstancesDynamic", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010400000002000, 1, nullptr, STRUCT_OFFSET(ULandscapeComponent, MaterialInstancesDynamic), METADATA_PARAMS(NewProp_MaterialInstancesDynamic_MetaData, ARRAY_COUNT(NewProp_MaterialInstancesDynamic_MetaData)) };
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_MaterialInstancesDynamic_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "MaterialInstancesDynamic", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_MaterialInstancesDynamic,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_MaterialInstancesDynamic_Inner,
	...
	IMPLEMENT_CLASS(ULandscapeComponent, 2372102839);
