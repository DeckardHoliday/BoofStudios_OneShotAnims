...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_CopyPoseFromMesh
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_CopyPoseFromMesh()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			auto NewProp_bCopyCurves_SetBit = [](void* Obj){ ((FAnimNode_CopyPoseFromMesh*)Obj)->bCopyCurves = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bCopyCurves = { UE4CodeGen_Private::EPropertyClass::Bool, "bCopyCurves", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNode_CopyPoseFromMesh), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bCopyCurves_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bCopyCurves_MetaData, ARRAY_COUNT(NewProp_bCopyCurves_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bCopyCurves,
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_CopyPoseFromMesh_CRC() { return 1068969514U; }
