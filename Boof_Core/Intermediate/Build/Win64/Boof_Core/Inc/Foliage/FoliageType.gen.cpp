...
static struct FScriptStruct_Foliage_StaticRegisterNativesFFoliageVertexColorChannelMask
{
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_LightmapType = { UE4CodeGen_Private::EPropertyClass::Enum, "LightmapType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000015, 1, nullptr, STRUCT_OFFSET(UFoliageType, LightmapType), Z_Construct_UEnum_Engine_ELightmapType, METADATA_PARAMS(NewProp_LightmapType_MetaData, ARRAY_COUNT(NewProp_LightmapType_MetaData)) };
	...
	IMPLEMENT_CLASS(UFoliageType, 3747931828);
