...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_UpdatedActors = { UE4CodeGen_Private::EPropertyClass::Array, "UpdatedActors", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000008000182, 1, nullptr, STRUCT_OFFSET(_Script_AIModule_eventPerceptionUpdatedDelegate_Parms, UpdatedActors), METADATA_PARAMS(NewProp_UpdatedActors_MetaData, ARRAY_COUNT(NewProp_UpdatedActors_MetaData)) };
...
static struct FScriptStruct_AIModule_StaticRegisterNativesFActorPerceptionBlueprintInfo
{
	...
	IMPLEMENT_CLASS(UAIPerceptionComponent, 2578818525);
