...
static struct FScriptStruct_AIModule_StaticRegisterNativesFPawnActionEvent
{
	...
	UClass* Z_Construct_UClass_UPawnActionsComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_UPawnActionsComponent_K2_AbortAction, "K2_AbortAction" }, // 1979021675
				{ &Z_Construct_UFunction_UPawnActionsComponent_K2_ForceAbortAction, "K2_ForceAbortAction" }, // 2490622853
				{ &Z_Construct_UFunction_UPawnActionsComponent_K2_PerformAction, "K2_PerformAction" }, // 1363388568
				{ &Z_Construct_UFunction_UPawnActionsComponent_K2_PushAction, "K2_PushAction" }, // 3911126368
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UPawnActionsComponent, 1925035926);
