...
static struct FScriptStruct_AIModule_StaticRegisterNativesFBTDecoratorLogic
{
	...
	UClass* Z_Construct_UClass_UBTCompositeNode()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bApplyDecoratorScope_SetBit = [](void* Obj){ ((UBTCompositeNode*)Obj)->bApplyDecoratorScope = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bApplyDecoratorScope = { UE4CodeGen_Private::EPropertyClass::Bool, "bApplyDecoratorScope", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UBTCompositeNode), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bApplyDecoratorScope_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bApplyDecoratorScope_MetaData, ARRAY_COUNT(NewProp_bApplyDecoratorScope_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bApplyDecoratorScope,
	...
	IMPLEMENT_CLASS(UBTCompositeNode, 1335403550);
