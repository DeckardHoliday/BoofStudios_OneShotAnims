...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_NavAgentProperties = { UE4CodeGen_Private::EPropertyClass::Struct, "NavAgentProperties", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, STRUCT_OFFSET(AEQSTestingPawn, NavAgentProperties), Z_Construct_UScriptStruct_FNavAgentProperties, METADATA_PARAMS(NewProp_NavAgentProperties_MetaData, ARRAY_COUNT(NewProp_NavAgentProperties_MetaData)) };
#if WITH_METADATA
...
#endif // WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_NavAgentProperties,
	...
	IMPLEMENT_CLASS(AEQSTestingPawn, 1575817136);
