...
// End Cross Module References
	void USourceControlHelpers::StaticRegisterNativesUSourceControlHelpers()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AbsoluteFilenames", &USourceControlHelpers::execAbsoluteFilenames },
			{ "CheckOutFile", &USourceControlHelpers::execCheckOutFile },
			{ "CopyFileUnderSourceControl", &USourceControlHelpers::execCopyFileUnderSourceControl },
			{ "MarkFileForAdd", &USourceControlHelpers::execMarkFileForAdd },
			{ "PackageFilename", &USourceControlHelpers::execPackageFilename },
			{ "PackageFilenames", &USourceControlHelpers::execPackageFilenames },
		};
