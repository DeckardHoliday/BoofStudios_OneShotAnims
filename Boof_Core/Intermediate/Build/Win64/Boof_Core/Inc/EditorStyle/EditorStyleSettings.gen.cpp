...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UEditorStyleSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bEnableHighDPIAwareness_SetBit = [](void* Obj){ ((UEditorStyleSettings*)Obj)->bEnableHighDPIAwareness = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableHighDPIAwareness = { UE4CodeGen_Private::EPropertyClass::Bool, "bEnableHighDPIAwareness", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UEditorStyleSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bEnableHighDPIAwareness_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bEnableHighDPIAwareness_MetaData, ARRAY_COUNT(NewProp_bEnableHighDPIAwareness_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bEnableHighDPIAwareness,
			};
	...
	IMPLEMENT_CLASS(UEditorStyleSettings, 2251951302);
