...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationField
{
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_Groups = { UE4CodeGen_Private::EPropertyClass::Array, "Groups", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationField, Groups), METADATA_PARAMS(NewProp_Groups_MetaData, ARRAY_COUNT(NewProp_Groups_MetaData)) };
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_Ranges = { UE4CodeGen_Private::EPropertyClass::Array, "Ranges", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationField, Ranges), METADATA_PARAMS(NewProp_Ranges_MetaData, ARRAY_COUNT(NewProp_Ranges_MetaData)) };
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Signature = { UE4CodeGen_Private::EPropertyClass::Struct, "Signature", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationField, Signature), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(NewProp_Signature_MetaData, ARRAY_COUNT(NewProp_Signature_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationField_CRC() { return 122099549U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationMetaData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneEvaluationMetaData()
	{
		...
		if (!ReturnStruct)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SubSequenceSignatures_MetaData[] = {
				{ "ModuleRelativePath", "Public/Evaluation/MovieSceneEvaluationField.h" },
				{ "ToolTip", "Map of sub sequence IDs to signatures that this meta data was generated with (not including root." },
			};
#endif
			static const UE4CodeGen_Private::FMapPropertyParams NewProp_SubSequenceSignatures = { UE4CodeGen_Private::EPropertyClass::Map, "SubSequenceSignatures", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationMetaData, SubSequenceSignatures), METADATA_PARAMS(NewProp_SubSequenceSignatures_MetaData, ARRAY_COUNT(NewProp_SubSequenceSignatures_MetaData)) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SubSequenceSignatures_Key_KeyProp = { UE4CodeGen_Private::EPropertyClass::Struct, "SubSequenceSignatures_Key", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FMovieSceneSequenceID, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SubSequenceSignatures_ValueProp = { UE4CodeGen_Private::EPropertyClass::Struct, "SubSequenceSignatures", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 1, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SubSequenceSignatures,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SubSequenceSignatures_Key_KeyProp,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SubSequenceSignatures_ValueProp,
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationMetaData_CRC() { return 1274907157U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationFieldSegmentPtr
{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SegmentID = { UE4CodeGen_Private::EPropertyClass::Struct, "SegmentID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationFieldSegmentPtr, SegmentID), Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier, METADATA_PARAMS(NewProp_SegmentID_MetaData, ARRAY_COUNT(NewProp_SegmentID_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SegmentID,
			};
			static const UE4CodeGen_Private::FStructParams ReturnStructParams = {
				(UObject* (*)())Z_Construct_UPackage__Script_MovieScene,
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationFieldSegmentPtr_CRC() { return 2774971659U; }
