...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_DefaultCompletionMode = { UE4CodeGen_Private::EPropertyClass::Enum, "DefaultCompletionMode", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004000, 1, nullptr, STRUCT_OFFSET(UMovieSceneSequence, DefaultCompletionMode), Z_Construct_UEnum_MovieScene_EMovieSceneCompletionMode, METADATA_PARAMS(NewProp_DefaultCompletionMode_MetaData, ARRAY_COUNT(NewProp_DefaultCompletionMode_MetaData)) };
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_DefaultCompletionMode_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PrecompiledEvaluationTemplate_MetaData[] = {
				{ "ModuleRelativePath", "Public/MovieSceneSequence.h" },
			};
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_PrecompiledEvaluationTemplate = { UE4CodeGen_Private::EPropertyClass::Struct, "PrecompiledEvaluationTemplate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010008000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneSequence, PrecompiledEvaluationTemplate), Z_Construct_UScriptStruct_FMovieSceneEvaluationTemplate, METADATA_PARAMS(NewProp_PrecompiledEvaluationTemplate_MetaData, ARRAY_COUNT(NewProp_PrecompiledEvaluationTemplate_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bParentContextsAreSignificant,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultCompletionMode,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultCompletionMode_Underlying,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PrecompiledEvaluationTemplate,
			};
	...
	IMPLEMENT_CLASS(UMovieSceneSequence, 2987167066);
