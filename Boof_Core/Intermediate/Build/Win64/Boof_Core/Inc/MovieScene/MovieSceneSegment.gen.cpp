...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSegmentIdentifier
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FMovieSceneSegmentIdentifier>(); };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_IdentifierIndex_MetaData[] = {
				{ "ModuleRelativePath", "Public/Evaluation/MovieSceneSegment.h" },
			};
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_IdentifierIndex = { UE4CodeGen_Private::EPropertyClass::Int, "IdentifierIndex", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneSegmentIdentifier, IdentifierIndex), METADATA_PARAMS(NewProp_IdentifierIndex_MetaData, ARRAY_COUNT(NewProp_IdentifierIndex_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_IdentifierIndex,
			};
			static const UE4CodeGen_Private::FStructParams ReturnStructParams = {
				(UObject* (*)())Z_Construct_UPackage__Script_MovieScene,
				nullptr,
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_CRC() { return 2863150255U; }
