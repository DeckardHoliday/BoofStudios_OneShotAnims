...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_ChildFolders = { UE4CodeGen_Private::EPropertyClass::Array, "ChildFolders", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040008000000008, 1, nullptr, STRUCT_OFFSET(UMovieSceneFolder, ChildFolders), METADATA_PARAMS(NewProp_ChildFolders_MetaData, ARRAY_COUNT(NewProp_ChildFolders_MetaData)) };
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ChildFolders_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "ChildFolders", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieSceneFolder, 421924278);
