...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSequenceHierarchy
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneSequenceHierarchy()
	{
		...
		if (!ReturnStruct)
		{
			...
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Hierarchy_Key_KeyProp = { UE4CodeGen_Private::EPropertyClass::Struct, "Hierarchy_Key", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FMovieSceneSequenceID, METADATA_PARAMS(nullptr, 0) };
			...
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SubSequences_Key_KeyProp = { UE4CodeGen_Private::EPropertyClass::Struct, "SubSequences_Key", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FMovieSceneSequenceID, METADATA_PARAMS(nullptr, 0) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSequenceHierarchy_CRC() { return 3336895076U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSubSequenceData
{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_InstanceData = { UE4CodeGen_Private::EPropertyClass::Struct, "InstanceData", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneSubSequenceData, InstanceData), Z_Construct_UScriptStruct_FMovieSceneSequenceInstanceDataPtr, METADATA_PARAMS(NewProp_InstanceData_MetaData, ARRAY_COUNT(NewProp_InstanceData_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_PlayRange = { UE4CodeGen_Private::EPropertyClass::Struct, "PlayRange", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneSubSequenceData, PlayRange), Z_Construct_UScriptStruct_FFloatRange, METADATA_PARAMS(NewProp_PlayRange_MetaData, ARRAY_COUNT(NewProp_PlayRange_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Sequence = { UE4CodeGen_Private::EPropertyClass::Struct, "Sequence", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneSubSequenceData, Sequence), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(NewProp_Sequence_MetaData, ARRAY_COUNT(NewProp_Sequence_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
#if WITH_EDITORONLY_DATA
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PlayRange,
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSubSequenceData_CRC() { return 1637474620U; }
