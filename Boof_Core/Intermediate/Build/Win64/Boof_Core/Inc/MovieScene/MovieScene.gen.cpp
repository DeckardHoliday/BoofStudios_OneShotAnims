...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneExpansionState
{
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_RootFolders = { UE4CodeGen_Private::EPropertyClass::Array, "RootFolders", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040008800000008, 1, nullptr, STRUCT_OFFSET(UMovieScene, RootFolders), METADATA_PARAMS(NewProp_RootFolders_MetaData, ARRAY_COUNT(NewProp_RootFolders_MetaData)) };
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_RootFolders_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "RootFolders", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800080008, 1, nullptr, 0, Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMovieScene, 1639480715);
