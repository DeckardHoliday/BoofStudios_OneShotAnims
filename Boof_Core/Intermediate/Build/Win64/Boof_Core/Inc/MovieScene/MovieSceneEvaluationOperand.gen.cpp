...
#include "Public/Evaluation/MovieSceneEvaluationOperand.h"
#ifdef _MSC_VER
#pragma warning (push)
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationOperand
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FMovieSceneEvaluationOperand>(); };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SequenceID = { UE4CodeGen_Private::EPropertyClass::Struct, "SequenceID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationOperand, SequenceID), Z_Construct_UScriptStruct_FMovieSceneSequenceID, METADATA_PARAMS(NewProp_SequenceID_MetaData, ARRAY_COUNT(NewProp_SequenceID_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand_CRC() { return 886972475U; }
