...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvaluationKey
{
...
#endif
			static const UE4CodeGen_Private::FUInt32PropertyParams NewProp_SectionIndex = { UE4CodeGen_Private::EPropertyClass::UInt32, "SectionIndex", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieSceneEvaluationKey, SectionIndex), METADATA_PARAMS(NewProp_SectionIndex_MetaData, ARRAY_COUNT(NewProp_SectionIndex_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvaluationKey_CRC() { return 488033313U; }
