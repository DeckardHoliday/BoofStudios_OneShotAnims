...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCompositeFont
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FCompositeFont()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_FallbackTypeface = { UE4CodeGen_Private::EPropertyClass::Struct, "FallbackTypeface", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FCompositeFont, FallbackTypeface), Z_Construct_UScriptStruct_FCompositeFallbackFont, METADATA_PARAMS(NewProp_FallbackTypeface_MetaData, ARRAY_COUNT(NewProp_FallbackTypeface_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FallbackTypeface,
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompositeFont_CRC() { return 3908841658U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCompositeSubFont
{
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_Cultures = { UE4CodeGen_Private::EPropertyClass::Str, "Cultures", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FCompositeSubFont, Cultures), METADATA_PARAMS(NewProp_Cultures_MetaData, ARRAY_COUNT(NewProp_Cultures_MetaData)) };
#if WITH_METADATA
...
#endif // WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Cultures,
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompositeSubFont_CRC() { return 113283178U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCompositeFallbackFont
{
...
#endif
			auto NewStructOpsLambda = []() -> void* { return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FCompositeFallbackFont>(); };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ScalingFactor = { UE4CodeGen_Private::EPropertyClass::Float, "ScalingFactor", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FCompositeFallbackFont, ScalingFactor), METADATA_PARAMS(NewProp_ScalingFactor_MetaData, ARRAY_COUNT(NewProp_ScalingFactor_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Typeface = { UE4CodeGen_Private::EPropertyClass::Struct, "Typeface", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FCompositeFallbackFont, Typeface), Z_Construct_UScriptStruct_FTypeface, METADATA_PARAMS(NewProp_Typeface_MetaData, ARRAY_COUNT(NewProp_Typeface_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompositeFallbackFont_CRC() { return 3491768641U; }
