...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFSlateBrush
{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Tint = { UE4CodeGen_Private::EPropertyClass::Struct, "Tint", RF_Public|RF_Transient|RF_MarkAsNative, 0x00100008a0000000, 1, nullptr, STRUCT_OFFSET(FSlateBrush, Tint_DEPRECATED), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(NewProp_Tint_MetaData, ARRAY_COUNT(NewProp_Tint_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateBrush_CRC() { return 3682630050U; }
