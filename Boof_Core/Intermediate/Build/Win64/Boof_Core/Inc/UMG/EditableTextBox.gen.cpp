...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_Justification = { UE4CodeGen_Private::EPropertyClass::Byte, "Justification", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UEditableTextBox, Justification), Z_Construct_UEnum_Slate_ETextJustify, METADATA_PARAMS(NewProp_Justification_MetaData, ARRAY_COUNT(NewProp_Justification_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_VirtualKeyboardDismissAction = { UE4CodeGen_Private::EPropertyClass::Enum, "VirtualKeyboardDismissAction", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, STRUCT_OFFSET(UEditableTextBox, VirtualKeyboardDismissAction), Z_Construct_UEnum_Slate_EVirtualKeyboardDismissAction, METADATA_PARAMS(NewProp_VirtualKeyboardDismissAction_MetaData, ARRAY_COUNT(NewProp_VirtualKeyboardDismissAction_MetaData)) };
	...
	IMPLEMENT_CLASS(UEditableTextBox, 3168398233);
