...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMultiLineEditableText()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_VirtualKeyboardDismissAction = { UE4CodeGen_Private::EPropertyClass::Enum, "VirtualKeyboardDismissAction", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, STRUCT_OFFSET(UMultiLineEditableText, VirtualKeyboardDismissAction), Z_Construct_UEnum_Slate_EVirtualKeyboardDismissAction, METADATA_PARAMS(NewProp_VirtualKeyboardDismissAction_MetaData, ARRAY_COUNT(NewProp_VirtualKeyboardDismissAction_MetaData)) };
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_VirtualKeyboardDismissAction_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			auto NewProp_ClearKeyboardFocusOnCommit_SetBit = [](void* Obj){ ((UMultiLineEditableText*)Obj)->ClearKeyboardFocusOnCommit = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ClearKeyboardFocusOnCommit = { UE4CodeGen_Private::EPropertyClass::Bool, "ClearKeyboardFocusOnCommit", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMultiLineEditableText), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_ClearKeyboardFocusOnCommit_SetBit)>::SetBit, METADATA_PARAMS(NewProp_ClearKeyboardFocusOnCommit_MetaData, ARRAY_COUNT(NewProp_ClearKeyboardFocusOnCommit_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_RevertTextOnEscape_SetBit = [](void* Obj){ ((UMultiLineEditableText*)Obj)->RevertTextOnEscape = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_RevertTextOnEscape = { UE4CodeGen_Private::EPropertyClass::Bool, "RevertTextOnEscape", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMultiLineEditableText), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_RevertTextOnEscape_SetBit)>::SetBit, METADATA_PARAMS(NewProp_RevertTextOnEscape_MetaData, ARRAY_COUNT(NewProp_RevertTextOnEscape_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_ClearTextSelectionOnFocusLoss_SetBit = [](void* Obj){ ((UMultiLineEditableText*)Obj)->ClearTextSelectionOnFocusLoss = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ClearTextSelectionOnFocusLoss = { UE4CodeGen_Private::EPropertyClass::Bool, "ClearTextSelectionOnFocusLoss", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMultiLineEditableText), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_ClearTextSelectionOnFocusLoss_SetBit)>::SetBit, METADATA_PARAMS(NewProp_ClearTextSelectionOnFocusLoss_MetaData, ARRAY_COUNT(NewProp_ClearTextSelectionOnFocusLoss_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_SelectAllTextWhenFocused_SetBit = [](void* Obj){ ((UMultiLineEditableText*)Obj)->SelectAllTextWhenFocused = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_SelectAllTextWhenFocused = { UE4CodeGen_Private::EPropertyClass::Bool, "SelectAllTextWhenFocused", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UMultiLineEditableText), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_SelectAllTextWhenFocused_SetBit)>::SetBit, METADATA_PARAMS(NewProp_SelectAllTextWhenFocused_MetaData, ARRAY_COUNT(NewProp_SelectAllTextWhenFocused_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_VirtualKeyboardDismissAction,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_VirtualKeyboardDismissAction_Underlying,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ClearTextSelectionOnFocusLoss,
	...
	IMPLEMENT_CLASS(UMultiLineEditableText, 1157632894);
