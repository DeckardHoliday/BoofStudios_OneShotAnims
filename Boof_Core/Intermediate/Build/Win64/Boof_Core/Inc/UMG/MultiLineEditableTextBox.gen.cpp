...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_VirtualKeyboardDismissAction = { UE4CodeGen_Private::EPropertyClass::Enum, "VirtualKeyboardDismissAction", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, STRUCT_OFFSET(UMultiLineEditableTextBox, VirtualKeyboardDismissAction), Z_Construct_UEnum_Slate_EVirtualKeyboardDismissAction, METADATA_PARAMS(NewProp_VirtualKeyboardDismissAction_MetaData, ARRAY_COUNT(NewProp_VirtualKeyboardDismissAction_MetaData)) };
	...
	IMPLEMENT_CLASS(UMultiLineEditableTextBox, 990984830);
