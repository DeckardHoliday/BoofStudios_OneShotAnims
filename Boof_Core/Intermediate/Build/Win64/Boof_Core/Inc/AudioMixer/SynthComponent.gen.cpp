...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_EnvelopeValue = { UE4CodeGen_Private::EPropertyClass::Float, "EnvelopeValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_AudioMixer_eventOnSynthEnvelopeValue_Parms, EnvelopeValue), METADATA_PARAMS(NewProp_EnvelopeValue_MetaData, ARRAY_COUNT(NewProp_EnvelopeValue_MetaData)) };
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AudioMixer, "OnSynthEnvelopeValue__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00130000, sizeof(_Script_AudioMixer_eventOnSynthEnvelopeValue_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
	...
	IMPLEMENT_CLASS(USynthSound, 1434180085);
	...
	UFunction* Z_Construct_UFunction_USynthComponent_SetVolumeMultiplier()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_VolumeMultiplier = { UE4CodeGen_Private::EPropertyClass::Float, "VolumeMultiplier", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(SynthComponent_eventSetVolumeMultiplier_Parms, VolumeMultiplier), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_USynthComponent, "SetVolumeMultiplier", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(SynthComponent_eventSetVolumeMultiplier_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_USynthComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_USynthComponent_SetVolumeMultiplier, "SetVolumeMultiplier" }, // 1147720066
...
#endif
			static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnAudioEnvelopeValue = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnAudioEnvelopeValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000010080000, 1, nullptr, STRUCT_OFFSET(USynthComponent, OnAudioEnvelopeValue), Z_Construct_UDelegateFunction_AudioMixer_OnSynthEnvelopeValue__DelegateSignature, METADATA_PARAMS(NewProp_OnAudioEnvelopeValue_MetaData, ARRAY_COUNT(NewProp_OnAudioEnvelopeValue_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PreEffectBusSends = { UE4CodeGen_Private::EPropertyClass::Array, "PreEffectBusSends", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(USynthComponent, PreEffectBusSends), METADATA_PARAMS(NewProp_PreEffectBusSends_MetaData, ARRAY_COUNT(NewProp_PreEffectBusSends_MetaData)) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_PreEffectBusSends_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "PreEffectBusSends", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FSoundSourceBusSendInfo, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_BusSends = { UE4CodeGen_Private::EPropertyClass::Array, "BusSends", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(USynthComponent, BusSends), METADATA_PARAMS(NewProp_BusSends_MetaData, ARRAY_COUNT(NewProp_BusSends_MetaData)) };
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_OnAudioEnvelopeValue,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PreEffectBusSends,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PreEffectBusSends_Inner,
	...
	IMPLEMENT_CLASS(USynthComponent, 4108702888);
