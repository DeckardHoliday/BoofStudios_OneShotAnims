...
static struct FScriptStruct_Engine_StaticRegisterNativesFPhysicalAnimationProfile
{
	...
	UClass* Z_Construct_UClass_USkeletalBodySetup()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bSkipScaleFromAnimation_SetBit = [](void* Obj){ ((USkeletalBodySetup*)Obj)->bSkipScaleFromAnimation = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSkipScaleFromAnimation = { UE4CodeGen_Private::EPropertyClass::Bool, "bSkipScaleFromAnimation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(USkeletalBodySetup), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSkipScaleFromAnimation_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSkipScaleFromAnimation_MetaData, ARRAY_COUNT(NewProp_bSkipScaleFromAnimation_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSkipScaleFromAnimation,
#if WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(USkeletalBodySetup, 1697188410);
