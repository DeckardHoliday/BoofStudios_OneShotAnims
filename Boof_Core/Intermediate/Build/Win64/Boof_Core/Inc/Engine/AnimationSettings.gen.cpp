...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAnimationSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bTickAnimationOnSkeletalMeshInit_SetBit = [](void* Obj){ ((UAnimationSettings*)Obj)->bTickAnimationOnSkeletalMeshInit = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bTickAnimationOnSkeletalMeshInit = { UE4CodeGen_Private::EPropertyClass::Bool, "bTickAnimationOnSkeletalMeshInit", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UAnimationSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bTickAnimationOnSkeletalMeshInit_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bTickAnimationOnSkeletalMeshInit_MetaData, ARRAY_COUNT(NewProp_bTickAnimationOnSkeletalMeshInit_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bTickAnimationOnSkeletalMeshInit,
	...
	IMPLEMENT_CLASS(UAnimationSettings, 653241511);
