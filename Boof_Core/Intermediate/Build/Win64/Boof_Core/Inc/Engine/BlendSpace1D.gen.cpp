...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UBlendSpace1D()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bScaleAnimation = { UE4CodeGen_Private::EPropertyClass::Bool, "bScaleAnimation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UBlendSpace1D), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bScaleAnimation_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bScaleAnimation_MetaData, ARRAY_COUNT(NewProp_bScaleAnimation_MetaData)) };
	...
	IMPLEMENT_CLASS(UBlendSpace1D, 2741006555);
