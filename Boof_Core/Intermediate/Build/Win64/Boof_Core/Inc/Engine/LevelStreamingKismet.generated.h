...
#define Engine_Source_Runtime_Engine_Classes_Engine_LevelStreamingKismet_h_20_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(ULevelStreamingKismet**)Z_Param__Result=ULevelStreamingKismet::LoadLevelInstanceBySoftObjectPtr(Z_Param_WorldContextObject,Z_Param_Level,Z_Param_Location,Z_Param_Rotation,Z_Param_Out_bOutSuccess); \
		P_NATIVE_END; \
	} \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(ULevelStreamingKismet**)Z_Param__Result=ULevelStreamingKismet::LoadLevelInstance(Z_Param_WorldContextObject,Z_Param_LevelName,Z_Param_Location,Z_Param_Rotation,Z_Param_Out_bOutSuccess); \
		P_NATIVE_END; \
	}
