...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialUsage_CRC() { return 3457057785U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFLightmassMaterialInterfaceSettings
{
	...
	UClass* Z_Construct_UClass_UMaterialInterface()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_AssetImportData = { UE4CodeGen_Private::EPropertyClass::Object, "AssetImportData", RF_Public|RF_Transient|RF_MarkAsNative, 0x0012010800080009, 1, nullptr, STRUCT_OFFSET(UMaterialInterface, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(NewProp_AssetImportData_MetaData, ARRAY_COUNT(NewProp_AssetImportData_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LayerParameterExpansion_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Materials/MaterialInterface.h" },
			};
#endif
			static const UE4CodeGen_Private::FMapPropertyParams NewProp_LayerParameterExpansion = { UE4CodeGen_Private::EPropertyClass::Map, "LayerParameterExpansion", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000800000000, 1, nullptr, STRUCT_OFFSET(UMaterialInterface, LayerParameterExpansion), METADATA_PARAMS(NewProp_LayerParameterExpansion_MetaData, ARRAY_COUNT(NewProp_LayerParameterExpansion_MetaData)) };
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_LayerParameterExpansion_Key_KeyProp = { UE4CodeGen_Private::EPropertyClass::Str, "LayerParameterExpansion_Key", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_LayerParameterExpansion_ValueProp = { UE4CodeGen_Private::EPropertyClass::Bool, "LayerParameterExpansion", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_LayerParameterExpansion,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_LayerParameterExpansion_Key_KeyProp,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_LayerParameterExpansion_ValueProp,
	...
	IMPLEMENT_CLASS(UMaterialInterface, 2840063775);
