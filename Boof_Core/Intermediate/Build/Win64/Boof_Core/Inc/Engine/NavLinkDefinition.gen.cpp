...
static struct FScriptStruct_Engine_StaticRegisterNativesFNavigationLink
{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Right = { UE4CodeGen_Private::EPropertyClass::Struct, "Right", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FNavigationLink, Right), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(NewProp_Right_MetaData, ARRAY_COUNT(NewProp_Right_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FNavigationLink_CRC() { return 1793314859U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFNavigationLinkBase
{
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_Direction = { UE4CodeGen_Private::EPropertyClass::Byte, "Direction", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FNavigationLinkBase, Direction), Z_Construct_UEnum_Engine_ENavLinkDirection, METADATA_PARAMS(NewProp_Direction_MetaData, ARRAY_COUNT(NewProp_Direction_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FNavigationLinkBase_CRC() { return 2943826461U; }
