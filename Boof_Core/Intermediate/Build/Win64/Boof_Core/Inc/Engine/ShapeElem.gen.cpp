...
static struct FScriptStruct_Engine_StaticRegisterNativesFKShapeElem
{
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_Name = { UE4CodeGen_Private::EPropertyClass::Str, "Name", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000800000001, 1, nullptr, STRUCT_OFFSET(FKShapeElem, Name), METADATA_PARAMS(NewProp_Name_MetaData, ARRAY_COUNT(NewProp_Name_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FKShapeElem_CRC() { return 3331810352U; }
