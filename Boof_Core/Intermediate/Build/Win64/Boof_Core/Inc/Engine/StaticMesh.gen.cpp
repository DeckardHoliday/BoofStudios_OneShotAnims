...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticMeshOptimizationSettings
{
...
#endif
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FlexAsset_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Engine/StaticMesh.h" },
				{ "ToolTip", "Properties for the associated Flex object" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_FlexAsset = { UE4CodeGen_Private::EPropertyClass::Object, "FlexAsset", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UStaticMesh, FlexAsset_DEPRECATED), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(NewProp_FlexAsset_MetaData, ARRAY_COUNT(NewProp_FlexAsset_MetaData)) };
#if WITH_METADATA
...
#endif // WITH_EDITORONLY_DATA
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FlexAsset,
	...
	IMPLEMENT_CLASS(UStaticMesh, 3565779010);
