...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EAutoExposureMethodUI_CRC() { return 2205667659U; }
	...
	UClass* Z_Construct_UClass_URendererSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bSupportMaterialLayers_SetBit = [](void* Obj){ ((URendererSettings*)Obj)->bSupportMaterialLayers = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSupportMaterialLayers = { UE4CodeGen_Private::EPropertyClass::Bool, "bSupportMaterialLayers", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(URendererSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSupportMaterialLayers_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSupportMaterialLayers_MetaData, ARRAY_COUNT(NewProp_bSupportMaterialLayers_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bMobileEnableMovableLightCSMShaderCulling_SetBit = [](void* Obj){ ((URendererSettings*)Obj)->bMobileEnableMovableLightCSMShaderCulling = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bMobileEnableMovableLightCSMShaderCulling = { UE4CodeGen_Private::EPropertyClass::Bool, "bMobileEnableMovableLightCSMShaderCulling", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(URendererSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bMobileEnableMovableLightCSMShaderCulling_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bMobileEnableMovableLightCSMShaderCulling_MetaData, ARRAY_COUNT(NewProp_bMobileEnableMovableLightCSMShaderCulling_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bGPUParticlesLocalVFOnly_MetaData[] = {
				{ "Category", "Optimizations" },
				{ "DisplayName", "GPU Particles Support Only Local Vector Field" },
				{ "ModuleRelativePath", "Classes/Engine/RendererSettings.h" },
				{ "Tooltip", "Limits Cascade GPU Particle simulations to applying local vector fields.  Global vector fields are not applied." },
			};
#endif
			auto NewProp_bGPUParticlesLocalVFOnly_SetBit = [](void* Obj){ ((URendererSettings*)Obj)->bGPUParticlesLocalVFOnly = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bGPUParticlesLocalVFOnly = { UE4CodeGen_Private::EPropertyClass::Bool, "bGPUParticlesLocalVFOnly", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(URendererSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bGPUParticlesLocalVFOnly_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bGPUParticlesLocalVFOnly_MetaData, ARRAY_COUNT(NewProp_bGPUParticlesLocalVFOnly_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultSpotLightUnits_MetaData[] = {
				{ "Category", "DefaultSettings" },
				{ "ConsoleVariable", "r.DefaultFeature.SpotLightUnits" },
				{ "DisplayName", "Spot Light Units" },
				{ "ModuleRelativePath", "Classes/Engine/RendererSettings.h" },
				{ "ToolTip", "Which units to use for spot lights" },
			};
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_DefaultSpotLightUnits = { UE4CodeGen_Private::EPropertyClass::Enum, "DefaultSpotLightUnits", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, STRUCT_OFFSET(URendererSettings, DefaultSpotLightUnits), Z_Construct_UEnum_Engine_ELightUnits, METADATA_PARAMS(NewProp_DefaultSpotLightUnits_MetaData, ARRAY_COUNT(NewProp_DefaultSpotLightUnits_MetaData)) };
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_DefaultSpotLightUnits_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DefaultPointLightUnits_MetaData[] = {
				{ "Category", "DefaultSettings" },
				{ "ConsoleVariable", "r.DefaultFeature.PointLightUnits" },
				{ "DisplayName", "Point Light Units" },
				{ "ModuleRelativePath", "Classes/Engine/RendererSettings.h" },
				{ "ToolTip", "Which units to use for point lights" },
			};
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_DefaultPointLightUnits = { UE4CodeGen_Private::EPropertyClass::Enum, "DefaultPointLightUnits", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, STRUCT_OFFSET(URendererSettings, DefaultPointLightUnits), Z_Construct_UEnum_Engine_ELightUnits, METADATA_PARAMS(NewProp_DefaultPointLightUnits_MetaData, ARRAY_COUNT(NewProp_DefaultPointLightUnits_MetaData)) };
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_DefaultPointLightUnits_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			auto NewProp_bTemporalUpsampling_SetBit = [](void* Obj){ ((URendererSettings*)Obj)->bTemporalUpsampling = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bTemporalUpsampling = { UE4CodeGen_Private::EPropertyClass::Bool, "bTemporalUpsampling", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(URendererSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bTemporalUpsampling_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bTemporalUpsampling_MetaData, ARRAY_COUNT(NewProp_bTemporalUpsampling_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bUsePreExposure_SetBit = [](void* Obj){ ((URendererSettings*)Obj)->bUsePreExposure = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUsePreExposure = { UE4CodeGen_Private::EPropertyClass::Bool, "bUsePreExposure", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(URendererSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bUsePreExposure_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bUsePreExposure_MetaData, ARRAY_COUNT(NewProp_bUsePreExposure_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSupportMaterialLayers,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bMobileEnableMovableLightCSMShaderCulling,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bGPUParticlesLocalVFOnly,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultSpotLightUnits,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultSpotLightUnits_Underlying,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultPointLightUnits,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultPointLightUnits_Underlying,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultFeatureAntiAliasing,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bTemporalUpsampling,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bUsePreExposure,
	...
	IMPLEMENT_CLASS(URendererSettings, 1819044100);
