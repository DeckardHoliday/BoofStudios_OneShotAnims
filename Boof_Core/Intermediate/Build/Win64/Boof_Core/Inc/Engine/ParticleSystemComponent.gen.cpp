...
// Cross Module References
	...
	ENGINE_API UFunction* Z_Construct_UFunction_UParticleSystemComponent_GetFirstFlexContainerTemplate();
...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleSysParam
{
	...
	void UParticleSystemComponent::StaticRegisterNativesUParticleSystemComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetFirstFlexContainerTemplate", &UParticleSystemComponent::execGetFirstFlexContainerTemplate },
	...
	UFunction* Z_Construct_UFunction_UParticleSystemComponent_GetFirstFlexContainerTemplate()
	{
		struct ParticleSystemComponent_eventGetFirstFlexContainerTemplate_Parms
		{
			UObject* ReturnValue;
		};
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Object, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000580, 1, nullptr, STRUCT_OFFSET(ParticleSystemComponent_eventGetFirstFlexContainerTemplate_Parms, ReturnValue), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ReturnValue,
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "Category", "Flex" },
				{ "ModuleRelativePath", "Classes/Particles/ParticleSystemComponent.h" },
				{ "ToolTip", "Get all of the Flex container templates from all of the emitter instances" },
			};
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_UParticleSystemComponent, "GetFirstFlexContainerTemplate", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(ParticleSystemComponent_eventGetFirstFlexContainerTemplate_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UParticleSystemComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UParticleSystemComponent_GetFirstFlexContainerTemplate, "GetFirstFlexContainerTemplate" }, // 3516846331
	...
	IMPLEMENT_CLASS(UParticleSystemComponent, 717721919);
