...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMaterialExpressionTextureSample()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_AutomaticViewMipBias_SetBit = [](void* Obj){ ((UMaterialExpressionTextureSample*)Obj)->AutomaticViewMipBias = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_AutomaticViewMipBias = { UE4CodeGen_Private::EPropertyClass::Bool, "AutomaticViewMipBias", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMaterialExpressionTextureSample), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_AutomaticViewMipBias_SetBit)>::SetBit, METADATA_PARAMS(NewProp_AutomaticViewMipBias_MetaData, ARRAY_COUNT(NewProp_AutomaticViewMipBias_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_AutomaticViewMipBias,
	...
	IMPLEMENT_CLASS(UMaterialExpressionTextureSample, 2706158835);
