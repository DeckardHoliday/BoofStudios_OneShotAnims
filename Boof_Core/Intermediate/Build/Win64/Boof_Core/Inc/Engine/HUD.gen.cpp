...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_AHUD, "NextDebugTarget", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020600, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_AHUD, "PreviousDebugTarget", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020600, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_AHUD()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_AHUD_NextDebugTarget, "NextDebugTarget" }, // 1899621495
				{ &Z_Construct_UFunction_AHUD_PreviousDebugTarget, "PreviousDebugTarget" }, // 2013151381
...
#endif
			static const UE4CodeGen_Private::FClassPropertyParams NewProp_ShowDebugTargetDesiredClass = { UE4CodeGen_Private::EPropertyClass::Class, "ShowDebugTargetDesiredClass", RF_Public|RF_Transient|RF_MarkAsNative, 0x0024080000000000, 1, nullptr, STRUCT_OFFSET(AHUD, ShowDebugTargetDesiredClass), Z_Construct_UClass_AActor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(NewProp_ShowDebugTargetDesiredClass_MetaData, ARRAY_COUNT(NewProp_ShowDebugTargetDesiredClass_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_CurrentTargetIndex = { UE4CodeGen_Private::EPropertyClass::Int, "CurrentTargetIndex", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000002000, 1, nullptr, STRUCT_OFFSET(AHUD, CurrentTargetIndex), METADATA_PARAMS(NewProp_CurrentTargetIndex_MetaData, ARRAY_COUNT(NewProp_CurrentTargetIndex_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CurrentTargetIndex,
	...
	IMPLEMENT_CLASS(AHUD, 3257906540);
