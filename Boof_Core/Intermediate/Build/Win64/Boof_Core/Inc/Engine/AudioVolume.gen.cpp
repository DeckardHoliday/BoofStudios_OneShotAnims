...
static struct FScriptStruct_Engine_StaticRegisterNativesFReverbSettings
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FReverbSettings()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReverbPluginEffect = { UE4CodeGen_Private::EPropertyClass::Object, "ReverbPluginEffect", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FReverbSettings, ReverbPluginEffect), Z_Construct_UClass_USoundEffectSubmixPreset_NoRegister, METADATA_PARAMS(NewProp_ReverbPluginEffect_MetaData, ARRAY_COUNT(NewProp_ReverbPluginEffect_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ReverbPluginEffect,
	...
	uint32 Get_Z_Construct_UScriptStruct_FReverbSettings_CRC() { return 1741491844U; }
	...
	IMPLEMENT_CLASS(AAudioVolume, 2922172533);
