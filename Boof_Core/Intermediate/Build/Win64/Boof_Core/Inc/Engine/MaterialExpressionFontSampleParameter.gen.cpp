...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_SortPriority = { UE4CodeGen_Private::EPropertyClass::Int, "SortPriority", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000800000001, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionFontSampleParameter, SortPriority), METADATA_PARAMS(NewProp_SortPriority_MetaData, ARRAY_COUNT(NewProp_SortPriority_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionFontSampleParameter, 688960043);
