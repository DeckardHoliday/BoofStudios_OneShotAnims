...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_AGameModeBase, "GetDefaultPawnClassForController", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x0C020C00, sizeof(GameModeBase_eventGetDefaultPawnClassForController_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_AGameModeBase()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_AGameModeBase_GetDefaultPawnClassForController, "GetDefaultPawnClassForController" }, // 1150073880
				...
				{ &Z_Construct_UFunction_AGameModeBase_K2_OnChangeName, "K2_OnChangeName" }, // 3379123266
				{ &Z_Construct_UFunction_AGameModeBase_K2_OnLogout, "K2_OnLogout" }, // 3486624585
				{ &Z_Construct_UFunction_AGameModeBase_K2_OnRestartPlayer, "K2_OnRestartPlayer" }, // 656179376
				{ &Z_Construct_UFunction_AGameModeBase_K2_OnSwapPlayerControllers, "K2_OnSwapPlayerControllers" }, // 3357773800
				{ &Z_Construct_UFunction_AGameModeBase_K2_PostLogin, "K2_PostLogin" }, // 1916794507
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ServerStatReplicator = { UE4CodeGen_Private::EPropertyClass::Object, "ServerStatReplicator", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000002000, 1, nullptr, STRUCT_OFFSET(AGameModeBase, ServerStatReplicator), Z_Construct_UClass_AServerStatReplicator_NoRegister, METADATA_PARAMS(NewProp_ServerStatReplicator_MetaData, ARRAY_COUNT(NewProp_ServerStatReplicator_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FClassPropertyParams NewProp_ServerStatReplicatorClass = { UE4CodeGen_Private::EPropertyClass::Class, "ServerStatReplicatorClass", RF_Public|RF_Transient|RF_MarkAsNative, 0x0014000002000015, 1, nullptr, STRUCT_OFFSET(AGameModeBase, ServerStatReplicatorClass), Z_Construct_UClass_AServerStatReplicator_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(NewProp_ServerStatReplicatorClass_MetaData, ARRAY_COUNT(NewProp_ServerStatReplicatorClass_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ServerStatReplicator,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ServerStatReplicatorClass,
	...
	IMPLEMENT_CLASS(AGameModeBase, 640625676);
