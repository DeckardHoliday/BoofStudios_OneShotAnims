...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ARecastNavMesh()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bFilterLowSpanFromTileCache_SetBit = [](void* Obj){ ((ARecastNavMesh*)Obj)->bFilterLowSpanFromTileCache = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bFilterLowSpanFromTileCache = { UE4CodeGen_Private::EPropertyClass::Bool, "bFilterLowSpanFromTileCache", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ARecastNavMesh), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bFilterLowSpanFromTileCache_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bFilterLowSpanFromTileCache_MetaData, ARRAY_COUNT(NewProp_bFilterLowSpanFromTileCache_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bFilterLowSpanSequences_SetBit = [](void* Obj){ ((ARecastNavMesh*)Obj)->bFilterLowSpanSequences = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bFilterLowSpanSequences = { UE4CodeGen_Private::EPropertyClass::Bool, "bFilterLowSpanSequences", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ARecastNavMesh), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bFilterLowSpanSequences_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bFilterLowSpanSequences_MetaData, ARRAY_COUNT(NewProp_bFilterLowSpanSequences_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bFilterLowSpanFromTileCache,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bFilterLowSpanSequences,
	...
	IMPLEMENT_CLASS(ARecastNavMesh, 223951612);
