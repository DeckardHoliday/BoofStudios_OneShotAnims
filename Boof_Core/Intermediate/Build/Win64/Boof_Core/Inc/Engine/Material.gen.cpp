...
static struct FScriptStruct_Engine_StaticRegisterNativesFMaterialFunctionInfo
{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Function = { UE4CodeGen_Private::EPropertyClass::Object, "Function", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMaterialFunctionInfo, Function), Z_Construct_UClass_UMaterialFunctionInterface_NoRegister, METADATA_PARAMS(NewProp_Function_MetaData, ARRAY_COUNT(NewProp_Function_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_StateId_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Materials/Material.h" },
	...
	uint32 Get_Z_Construct_UScriptStruct_FMaterialFunctionInfo_CRC() { return 1914949632U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FVector2MaterialInput_CRC() { return 1642728187U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FVectorMaterialInput_CRC() { return 2470957880U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FScalarMaterialInput_CRC() { return 3540815246U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FColorMaterialInput_CRC() { return 1506996325U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FMaterialInput_CRC() { return 658782860U; }
	...
	UClass* Z_Construct_UClass_UMaterial()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bIsFunctionPreviewMaterial_SetBit = [](void* Obj){ ((UMaterial*)Obj)->bIsFunctionPreviewMaterial = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsFunctionPreviewMaterial = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsFunctionPreviewMaterial", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000202000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMaterial), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsFunctionPreviewMaterial_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsFunctionPreviewMaterial_MetaData, ARRAY_COUNT(NewProp_bIsFunctionPreviewMaterial_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bUsedWithFlexMeshes_MetaData[] = {
				{ "Category", "Usage" },
				{ "ModuleRelativePath", "Classes/Materials/Material.h" },
				{ "ToolTip", "Indicates that the material and its instances can be use with flex deformable meshes.\nThis will result in the shaders required to support flex deformation being compiled which will increase shader compile time and memory usage." },
			};
#endif
			auto NewProp_bUsedWithFlexMeshes_SetBit = [](void* Obj){ ((UMaterial*)Obj)->bUsedWithFlexMeshes = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUsedWithFlexMeshes = { UE4CodeGen_Private::EPropertyClass::Bool, "bUsedWithFlexMeshes", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMaterial), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bUsedWithFlexMeshes_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bUsedWithFlexMeshes_MetaData, ARRAY_COUNT(NewProp_bUsedWithFlexMeshes_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bUsedWithFlexFluidSurfaces_MetaData[] = {
				{ "Category", "Usage" },
				{ "ModuleRelativePath", "Classes/Materials/Material.h" },
				{ "ToolTip", "Indicates that the material and its instances can be use with flex fluid surfaces\nThis will result in the shaders required to support flex fluid surfaces being compiled which will increase shader compile time and memory usage." },
			};
#endif
			auto NewProp_bUsedWithFlexFluidSurfaces_SetBit = [](void* Obj){ ((UMaterial*)Obj)->bUsedWithFlexFluidSurfaces = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUsedWithFlexFluidSurfaces = { UE4CodeGen_Private::EPropertyClass::Bool, "bUsedWithFlexFluidSurfaces", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMaterial), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bUsedWithFlexFluidSurfaces_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bUsedWithFlexFluidSurfaces_MetaData, ARRAY_COUNT(NewProp_bUsedWithFlexFluidSurfaces_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bIsFunctionPreviewMaterial,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bUsedWithFlexMeshes,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bUsedWithFlexFluidSurfaces,
	...
	IMPLEMENT_CLASS(UMaterial, 1637581546);
