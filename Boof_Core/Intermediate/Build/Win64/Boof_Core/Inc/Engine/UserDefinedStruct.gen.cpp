...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_Status = { UE4CodeGen_Private::EPropertyClass::Byte, "Status", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UUserDefinedStruct, Status), Z_Construct_UEnum_Engine_EUserDefinedStructureStatus, METADATA_PARAMS(NewProp_Status_MetaData, ARRAY_COUNT(NewProp_Status_MetaData)) };
	...
	IMPLEMENT_CLASS(UUserDefinedStruct, 3305955452);
