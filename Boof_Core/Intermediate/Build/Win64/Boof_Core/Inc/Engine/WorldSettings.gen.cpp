...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EVolumeLightingMethod_CRC() { return 1255799053U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EVisibilityAggressiveness_CRC() { return 1488099892U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFHierarchicalSimplification
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FHierarchicalSimplification()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			auto NewProp_bOnlyGenerateClustersForVolumes_SetBit = [](void* Obj){ ((FHierarchicalSimplification*)Obj)->bOnlyGenerateClustersForVolumes = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bOnlyGenerateClustersForVolumes = { UE4CodeGen_Private::EPropertyClass::Bool, "bOnlyGenerateClustersForVolumes", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FHierarchicalSimplification), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bOnlyGenerateClustersForVolumes_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bOnlyGenerateClustersForVolumes_MetaData, ARRAY_COUNT(NewProp_bOnlyGenerateClustersForVolumes_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bOnlyGenerateClustersForVolumes,
	...
	uint32 Get_Z_Construct_UScriptStruct_FHierarchicalSimplification_CRC() { return 3320854405U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFLightmassWorldInfoSettings
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FLightmassWorldInfoSettings()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_VolumetricLightmapSphericalHarmonicSmoothing = { UE4CodeGen_Private::EPropertyClass::Float, "VolumetricLightmapSphericalHarmonicSmoothing", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, STRUCT_OFFSET(FLightmassWorldInfoSettings, VolumetricLightmapSphericalHarmonicSmoothing), METADATA_PARAMS(NewProp_VolumetricLightmapSphericalHarmonicSmoothing_MetaData, ARRAY_COUNT(NewProp_VolumetricLightmapSphericalHarmonicSmoothing_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_VolumetricLightmapSphericalHarmonicSmoothing,
	...
	uint32 Get_Z_Construct_UScriptStruct_FLightmassWorldInfoSettings_CRC() { return 4084548288U; }
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_HierarchicalLODSetup = { UE4CodeGen_Private::EPropertyClass::Array, "HierarchicalLODSetup", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UHierarchicalLODSetup, HierarchicalLODSetup), METADATA_PARAMS(NewProp_HierarchicalLODSetup_MetaData, ARRAY_COUNT(NewProp_HierarchicalLODSetup_MetaData)) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_HierarchicalLODSetup_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "HierarchicalLODSetup", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FHierarchicalSimplification, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	IMPLEMENT_CLASS(UHierarchicalLODSetup, 2656884814);
...
#endif
			auto NewProp_bGenerateSingleClusterForLevel_SetBit = [](void* Obj){ ((AWorldSettings*)Obj)->bGenerateSingleClusterForLevel = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bGenerateSingleClusterForLevel = { UE4CodeGen_Private::EPropertyClass::Bool, "bGenerateSingleClusterForLevel", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040800004001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(AWorldSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bGenerateSingleClusterForLevel_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bGenerateSingleClusterForLevel_MetaData, ARRAY_COUNT(NewProp_bGenerateSingleClusterForLevel_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_HierarchicalLODSetup = { UE4CodeGen_Private::EPropertyClass::Array, "HierarchicalLODSetup", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080800004001, 1, nullptr, STRUCT_OFFSET(AWorldSettings, HierarchicalLODSetup), METADATA_PARAMS(NewProp_HierarchicalLODSetup_MetaData, ARRAY_COUNT(NewProp_HierarchicalLODSetup_MetaData)) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_HierarchicalLODSetup_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "HierarchicalLODSetup", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800004000, 1, nullptr, 0, Z_Construct_UScriptStruct_FHierarchicalSimplification, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_HLODSetupAsset_MetaData[] = {
				{ "Category", "LODSystem" },
				{ "ModuleRelativePath", "Classes/GameFramework/WorldSettings.h" },
				{ "ToolTip", "If sets overrides the level settings and global project settings" },
			};
#endif
			static const UE4CodeGen_Private::FSoftClassPropertyParams NewProp_HLODSetupAsset = { UE4CodeGen_Private::EPropertyClass::SoftClass, "HLODSetupAsset", RF_Public|RF_Transient|RF_MarkAsNative, 0x0014000800004001, 1, nullptr, STRUCT_OFFSET(AWorldSettings, HLODSetupAsset), Z_Construct_UClass_UHierarchicalLODSetup_NoRegister, METADATA_PARAMS(NewProp_HLODSetupAsset_MetaData, ARRAY_COUNT(NewProp_HLODSetupAsset_MetaData)) };
#if WITH_METADATA
...
#if WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bGenerateSingleClusterForLevel,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_NumHLODLevels,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_HierarchicalLODSetup,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_HierarchicalLODSetup_Inner,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_HLODSetupAsset,
	...
	IMPLEMENT_CLASS(AWorldSettings, 1895643082);
