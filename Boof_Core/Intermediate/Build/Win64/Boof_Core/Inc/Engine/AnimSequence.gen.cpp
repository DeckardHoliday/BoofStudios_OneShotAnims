...
static struct FScriptStruct_Engine_StaticRegisterNativesFRawAnimSequenceTrack
{
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_AnimationTrackNames = { UE4CodeGen_Private::EPropertyClass::Array, "AnimationTrackNames", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080800020001, 1, nullptr, STRUCT_OFFSET(UAnimSequence, AnimationTrackNames), METADATA_PARAMS(NewProp_AnimationTrackNames_MetaData, ARRAY_COUNT(NewProp_AnimationTrackNames_MetaData)) };
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_AnimationTrackNames_Inner = { UE4CodeGen_Private::EPropertyClass::Name, "AnimationTrackNames", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800020000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimSequence, 2532891492);
