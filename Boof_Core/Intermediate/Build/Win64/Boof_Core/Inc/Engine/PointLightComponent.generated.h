...
#define Engine_Source_Runtime_Engine_Classes_Components_PointLightComponent_h_20_RPC_WRAPPERS \
 \
	...
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(float*)Z_Param__Result=UPointLightComponent::GetUnitsConversionFactor(ELightUnits(Z_Param_SrcUnits),ELightUnits(Z_Param_TargetUnits),Z_Param_CosHalfConeAngle); \
		P_NATIVE_END; \
	} \
 \
