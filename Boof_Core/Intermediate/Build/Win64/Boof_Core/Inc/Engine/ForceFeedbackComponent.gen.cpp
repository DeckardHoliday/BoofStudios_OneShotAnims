...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UForceFeedbackComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UForceFeedbackComponent_BP_GetAttenuationSettingsToApply, "BP_GetAttenuationSettingsToApply" }, // 3230121204
	...
	IMPLEMENT_CLASS(UForceFeedbackComponent, 2425377115);
