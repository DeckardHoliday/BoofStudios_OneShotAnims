...
static struct FScriptStruct_Engine_StaticRegisterNativesFMeshProxySettings
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMeshProxySettings()
	{
		...
		if (!ReturnStruct)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAllowDistanceField_MetaData[] = {
				...
				{ "ModuleRelativePath", "Classes/Engine/MeshMerging.h" },
				{ "ToolTip", "Whether to allow distance field to be computed for this mesh.  Disable this to save memory if you mesh will only rendered in the distance." },
			};
#endif
			auto NewProp_bAllowDistanceField_SetBit = [](void* Obj){ ((FMeshProxySettings*)Obj)->bAllowDistanceField = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAllowDistanceField = { UE4CodeGen_Private::EPropertyClass::Bool, "bAllowDistanceField", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FMeshProxySettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bAllowDistanceField_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bAllowDistanceField_MetaData, ARRAY_COUNT(NewProp_bAllowDistanceField_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bAllowAdjacency_SetBit = [](void* Obj){ ((FMeshProxySettings*)Obj)->bAllowAdjacency = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAllowAdjacency = { UE4CodeGen_Private::EPropertyClass::Bool, "bAllowAdjacency", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FMeshProxySettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bAllowAdjacency_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bAllowAdjacency_MetaData, ARRAY_COUNT(NewProp_bAllowAdjacency_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_VoxelSize = { UE4CodeGen_Private::EPropertyClass::Float, "VoxelSize", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, STRUCT_OFFSET(FMeshProxySettings, VoxelSize), METADATA_PARAMS(NewProp_VoxelSize_MetaData, ARRAY_COUNT(NewProp_VoxelSize_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bOverrideVoxelSize_SetBit = [](void* Obj){ ((FMeshProxySettings*)Obj)->bOverrideVoxelSize = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bOverrideVoxelSize = { UE4CodeGen_Private::EPropertyClass::Bool, "bOverrideVoxelSize", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FMeshProxySettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bOverrideVoxelSize_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bOverrideVoxelSize_MetaData, ARRAY_COUNT(NewProp_bOverrideVoxelSize_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bAllowDistanceField,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bAllowAdjacency,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bOverrideVoxelSize,
	...
	uint32 Get_Z_Construct_UScriptStruct_FMeshProxySettings_CRC() { return 677022094U; }
