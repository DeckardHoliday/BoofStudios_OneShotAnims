...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNode_SequencePlayer
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAnimNode_SequencePlayer()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_PlayRateBasis = { UE4CodeGen_Private::EPropertyClass::Float, "PlayRateBasis", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FAnimNode_SequencePlayer, PlayRateBasis), METADATA_PARAMS(NewProp_PlayRateBasis_MetaData, ARRAY_COUNT(NewProp_PlayRateBasis_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PlayRateBasis,
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_CRC() { return 1421493872U; }
