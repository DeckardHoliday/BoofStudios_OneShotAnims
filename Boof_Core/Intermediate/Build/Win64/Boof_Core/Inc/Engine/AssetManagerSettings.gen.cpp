...
static struct FScriptStruct_Engine_StaticRegisterNativesFAssetManagerRedirect
{
	...
	UClass* Z_Construct_UClass_UAssetManagerSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bShouldManagerDetermineTypeAndName_SetBit = [](void* Obj){ ((UAssetManagerSettings*)Obj)->bShouldManagerDetermineTypeAndName = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bShouldManagerDetermineTypeAndName = { UE4CodeGen_Private::EPropertyClass::Bool, "bShouldManagerDetermineTypeAndName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UAssetManagerSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bShouldManagerDetermineTypeAndName_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bShouldManagerDetermineTypeAndName_MetaData, ARRAY_COUNT(NewProp_bShouldManagerDetermineTypeAndName_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bShouldManagerDetermineTypeAndName,
	...
	IMPLEMENT_CLASS(UAssetManagerSettings, 3605054208);
