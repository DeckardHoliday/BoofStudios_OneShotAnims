...
static struct FScriptStruct_Engine_StaticRegisterNativesFPacketSimulationSettings
{
	...
	UClass* Z_Construct_UClass_UNetDriver()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_WorldPackage = { UE4CodeGen_Private::EPropertyClass::Object, "WorldPackage", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UNetDriver, WorldPackage), Z_Construct_UClass_UPackage, METADATA_PARAMS(NewProp_WorldPackage_MetaData, ARRAY_COUNT(NewProp_WorldPackage_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_WorldPackage,
	...
	IMPLEMENT_CLASS(UNetDriver, 2128085388);
