...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_ULightComponent_SetForceCachedShadowsForMovablePrimitives()
	{
		...
		if (!ReturnFunction)
		{
			auto NewProp_bNewValue_SetBit = [](void* Obj){ ((LightComponent_eventSetForceCachedShadowsForMovablePrimitives_Parms*)Obj)->bNewValue = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bNewValue = { UE4CodeGen_Private::EPropertyClass::Bool, "bNewValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(LightComponent_eventSetForceCachedShadowsForMovablePrimitives_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bNewValue_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bNewValue,
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_ULightComponent, "SetForceCachedShadowsForMovablePrimitives", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(LightComponent_eventSetForceCachedShadowsForMovablePrimitives_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_ULightComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_ULightComponent_SetForceCachedShadowsForMovablePrimitives, "SetForceCachedShadowsForMovablePrimitives" }, // 3529287183
...
#endif
			auto NewProp_bForceCachedShadowsForMovablePrimitives_SetBit = [](void* Obj){ ((ULightComponent*)Obj)->bForceCachedShadowsForMovablePrimitives = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bForceCachedShadowsForMovablePrimitives = { UE4CodeGen_Private::EPropertyClass::Bool, "bForceCachedShadowsForMovablePrimitives", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(ULightComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bForceCachedShadowsForMovablePrimitives_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bForceCachedShadowsForMovablePrimitives_MetaData, ARRAY_COUNT(NewProp_bForceCachedShadowsForMovablePrimitives_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bForceCachedShadowsForMovablePrimitives,
	...
	IMPLEMENT_CLASS(ULightComponent, 4095027714);
