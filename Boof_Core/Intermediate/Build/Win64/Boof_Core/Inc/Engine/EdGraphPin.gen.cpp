...
static struct FScriptStruct_Engine_StaticRegisterNativesFEdGraphPinType
{
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_PinSubCategory = { UE4CodeGen_Private::EPropertyClass::Name, "PinSubCategory", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FEdGraphPinType, PinSubCategory), METADATA_PARAMS(NewProp_PinSubCategory_MetaData, ARRAY_COUNT(NewProp_PinSubCategory_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_PinCategory = { UE4CodeGen_Private::EPropertyClass::Name, "PinCategory", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FEdGraphPinType, PinCategory), METADATA_PARAMS(NewProp_PinCategory_MetaData, ARRAY_COUNT(NewProp_PinCategory_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FEdGraphPinType_CRC() { return 511883959U; }
