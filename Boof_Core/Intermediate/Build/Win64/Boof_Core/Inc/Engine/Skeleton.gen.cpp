...
static struct FScriptStruct_Engine_StaticRegisterNativesFReferencePose
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FReferencePose()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FSoftObjectPropertyParams NewProp_SourceReferenceMesh = { UE4CodeGen_Private::EPropertyClass::SoftObject, "SourceReferenceMesh", RF_Public|RF_Transient|RF_MarkAsNative, 0x0014000800000000, 1, nullptr, STRUCT_OFFSET(FReferencePose, SourceReferenceMesh), Z_Construct_UClass_USkeletalMesh_NoRegister, METADATA_PARAMS(NewProp_SourceReferenceMesh_MetaData, ARRAY_COUNT(NewProp_SourceReferenceMesh_MetaData)) };
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
#if WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SourceReferenceMesh,
#endif // WITH_EDITORONLY_DATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FReferencePose_CRC() { return 300876556U; }
