...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EVoiceSampleRate_CRC() { return 856610684U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioQualitySettings
{
	...
	UClass* Z_Construct_UClass_UAudioSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_VoipBufferingDelay = { UE4CodeGen_Private::EPropertyClass::Float, "VoipBufferingDelay", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000004001, 1, nullptr, STRUCT_OFFSET(UAudioSettings, VoipBufferingDelay), METADATA_PARAMS(NewProp_VoipBufferingDelay_MetaData, ARRAY_COUNT(NewProp_VoipBufferingDelay_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_VoiPSampleRate = { UE4CodeGen_Private::EPropertyClass::Enum, "VoiPSampleRate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, STRUCT_OFFSET(UAudioSettings, VoiPSampleRate), Z_Construct_UEnum_Engine_EVoiceSampleRate, METADATA_PARAMS(NewProp_VoiPSampleRate_MetaData, ARRAY_COUNT(NewProp_VoiPSampleRate_MetaData)) };
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_VoiPSampleRate_Underlying = { UE4CodeGen_Private::EPropertyClass::Int, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_VoipBufferingDelay,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_VoiPSampleRate,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_VoiPSampleRate_Underlying,
	...
	IMPLEMENT_CLASS(UAudioSettings, 273549645);
