...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_OutputName = { UE4CodeGen_Private::EPropertyClass::Name, "OutputName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionFunctionOutput, OutputName), METADATA_PARAMS(NewProp_OutputName_MetaData, ARRAY_COUNT(NewProp_OutputName_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionFunctionOutput, 2205224316);
