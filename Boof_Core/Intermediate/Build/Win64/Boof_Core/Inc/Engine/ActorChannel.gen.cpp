...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UActorChannel()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_CreateSubObjects = { UE4CodeGen_Private::EPropertyClass::Array, "CreateSubObjects", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UActorChannel, CreateSubObjects), METADATA_PARAMS(NewProp_CreateSubObjects_MetaData, ARRAY_COUNT(NewProp_CreateSubObjects_MetaData)) };
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CreateSubObjects_Inner = { UE4CodeGen_Private::EPropertyClass::Object, "CreateSubObjects", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CreateSubObjects,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CreateSubObjects_Inner,
	...
	IMPLEMENT_CLASS(UActorChannel, 960170193);
