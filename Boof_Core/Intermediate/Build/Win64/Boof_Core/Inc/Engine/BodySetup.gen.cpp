...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_BuildScale = { UE4CodeGen_Private::EPropertyClass::Float, "BuildScale", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000820000000, 1, nullptr, STRUCT_OFFSET(UBodySetup, BuildScale_DEPRECATED), METADATA_PARAMS(NewProp_BuildScale_MetaData, ARRAY_COUNT(NewProp_BuildScale_MetaData)) };
	...
	IMPLEMENT_CLASS(UBodySetup, 3578893865);
