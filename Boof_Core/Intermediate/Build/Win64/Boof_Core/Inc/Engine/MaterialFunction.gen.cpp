...
// End Cross Module References
...
#endif
			auto NewProp_bPrefixParameterNames_SetBit = [](void* Obj){ ((UMaterialFunction*)Obj)->bPrefixParameterNames = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bPrefixParameterNames = { UE4CodeGen_Private::EPropertyClass::Bool, "bPrefixParameterNames", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UMaterialFunction), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bPrefixParameterNames_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bPrefixParameterNames_MetaData, ARRAY_COUNT(NewProp_bPrefixParameterNames_MetaData)) };
#if WITH_METADATA
...
#endif // WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bPrefixParameterNames,
	...
	IMPLEMENT_CLASS(UMaterialFunction, 384169706);
