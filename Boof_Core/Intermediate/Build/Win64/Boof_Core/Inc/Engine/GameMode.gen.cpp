...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AGameMode()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_AGameMode_K2_OnSetMatchState, "K2_OnSetMatchState" }, // 2774780505
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_MaxInactivePlayers = { UE4CodeGen_Private::EPropertyClass::Int, "MaxInactivePlayers", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000001, 1, nullptr, STRUCT_OFFSET(AGameMode, MaxInactivePlayers), METADATA_PARAMS(NewProp_MaxInactivePlayers_MetaData, ARRAY_COUNT(NewProp_MaxInactivePlayers_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_MaxInactivePlayers,
	...
	IMPLEMENT_CLASS(AGameMode, 1633896177);
