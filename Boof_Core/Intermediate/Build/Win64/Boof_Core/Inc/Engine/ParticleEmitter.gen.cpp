...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleBurst
{
	...
	UClass* Z_Construct_UClass_UParticleEmitter()
	{
		...
		if (!OuterClass)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FlexFluidSurfaceTemplate_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Particles/ParticleEmitter.h" },
				{ "ToolTip", "LEGACY: Optional Flex fluid surface for rendering" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_FlexFluidSurfaceTemplate = { UE4CodeGen_Private::EPropertyClass::Object, "FlexFluidSurfaceTemplate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UParticleEmitter, FlexFluidSurfaceTemplate_DEPRECATED), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(NewProp_FlexFluidSurfaceTemplate_MetaData, ARRAY_COUNT(NewProp_FlexFluidSurfaceTemplate_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Mass_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Particles/ParticleEmitter.h" },
				{ "ToolTip", "Mass assigned to Flex particles" },
			};
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Mass = { UE4CodeGen_Private::EPropertyClass::Float, "Mass", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UParticleEmitter, Mass_DEPRECATED), METADATA_PARAMS(NewProp_Mass_MetaData, ARRAY_COUNT(NewProp_Mass_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InertialScale_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Particles/ParticleEmitter.h" },
				{ "ToolTip", "Control Local Inertial components" },
			};
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_InertialScale = { UE4CodeGen_Private::EPropertyClass::Struct, "InertialScale", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UParticleEmitter, InertialScale_DEPRECATED), Z_Construct_UScriptStruct_FFlexInertialScale, METADATA_PARAMS(NewProp_InertialScale_MetaData, ARRAY_COUNT(NewProp_InertialScale_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bLocalSpace_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Particles/ParticleEmitter.h" },
				{ "ToolTip", "Enable local-space simulation when parented" },
			};
#endif
			auto NewProp_bLocalSpace_SetBit = [](void* Obj){ ((UParticleEmitter*)Obj)->bLocalSpace_DEPRECATED = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bLocalSpace = { UE4CodeGen_Private::EPropertyClass::Bool, "bLocalSpace", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UParticleEmitter), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bLocalSpace_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bLocalSpace_MetaData, ARRAY_COUNT(NewProp_bLocalSpace_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Phase_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Particles/ParticleEmitter.h" },
				{ "ToolTip", "Phase assigned to spawned Flex particles" },
			};
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Phase = { UE4CodeGen_Private::EPropertyClass::Struct, "Phase", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UParticleEmitter, Phase_DEPRECATED), Z_Construct_UScriptStruct_FFlexPhase, METADATA_PARAMS(NewProp_Phase_MetaData, ARRAY_COUNT(NewProp_Phase_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FlexContainerTemplate_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Particles/ParticleEmitter.h" },
				{ "ToolTip", "The Flex container to emit into" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_FlexContainerTemplate = { UE4CodeGen_Private::EPropertyClass::Object, "FlexContainerTemplate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, STRUCT_OFFSET(UParticleEmitter, FlexContainerTemplate_DEPRECATED), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(NewProp_FlexContainerTemplate_MetaData, ARRAY_COUNT(NewProp_FlexContainerTemplate_MetaData)) };
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FlexFluidSurfaceTemplate,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Mass,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_InertialScale,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bLocalSpace,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_Phase,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FlexContainerTemplate,
#if WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UParticleEmitter, 1703844754);
