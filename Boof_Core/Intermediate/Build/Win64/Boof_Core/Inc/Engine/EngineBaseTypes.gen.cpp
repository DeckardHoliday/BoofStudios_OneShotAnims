...
static struct FScriptStruct_Engine_StaticRegisterNativesFExposureSettings
{
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_FixedEV100 = { UE4CodeGen_Private::EPropertyClass::Float, "FixedEV100", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FExposureSettings, FixedEV100), METADATA_PARAMS(NewProp_FixedEV100_MetaData, ARRAY_COUNT(NewProp_FixedEV100_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bFixed,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FixedEV100,
			};
	...
	uint32 Get_Z_Construct_UScriptStruct_FExposureSettings_CRC() { return 1284411019U; }
