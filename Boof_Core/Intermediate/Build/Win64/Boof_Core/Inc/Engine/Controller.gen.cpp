...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AController()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_AController_K2_GetPawn, "K2_GetPawn" }, // 4087867706
				...
				{ &Z_Construct_UFunction_AController_SetIgnoreMoveInput, "SetIgnoreMoveInput" }, // 1226627668
...
#endif
			static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnInstigatedAnyDamage = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnInstigatedAnyDamage", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000010080000, 1, nullptr, STRUCT_OFFSET(AController, OnInstigatedAnyDamage), Z_Construct_UDelegateFunction_Engine_InstigatedAnyDamageSignature__DelegateSignature, METADATA_PARAMS(NewProp_OnInstigatedAnyDamage_MetaData, ARRAY_COUNT(NewProp_OnInstigatedAnyDamage_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AController, 1558777777);
