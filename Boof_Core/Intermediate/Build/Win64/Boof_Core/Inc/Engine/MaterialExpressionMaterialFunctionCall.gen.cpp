...
static struct FScriptStruct_Engine_StaticRegisterNativesFFunctionExpressionInput
{
...
#if WITH_EDITOR
				{ &Z_Construct_UFunction_UMaterialExpressionMaterialFunctionCall_SetMaterialFunction, "SetMaterialFunction" }, // 2403366263
#endif //WITH_EDITOR
			};
#endif //WITH_EDITOR
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_FunctionParameterInfo = { UE4CodeGen_Private::EPropertyClass::Struct, "FunctionParameterInfo", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000002000, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionMaterialFunctionCall, FunctionParameterInfo), Z_Construct_UScriptStruct_FMaterialParameterInfo, METADATA_PARAMS(NewProp_FunctionParameterInfo_MetaData, ARRAY_COUNT(NewProp_FunctionParameterInfo_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_MaterialFunction = { UE4CodeGen_Private::EPropertyClass::Object, "MaterialFunction", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, STRUCT_OFFSET(UMaterialExpressionMaterialFunctionCall, MaterialFunction), Z_Construct_UClass_UMaterialFunctionInterface_NoRegister, METADATA_PARAMS(NewProp_MaterialFunction_MetaData, ARRAY_COUNT(NewProp_MaterialFunction_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_FunctionParameterInfo,
	...
	IMPLEMENT_CLASS(UMaterialExpressionMaterialFunctionCall, 745530005);
