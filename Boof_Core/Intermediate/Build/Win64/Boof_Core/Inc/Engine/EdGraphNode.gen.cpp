...
static struct FScriptStruct_Engine_StaticRegisterNativesFEdGraphTerminalType
{
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_TerminalSubCategory = { UE4CodeGen_Private::EPropertyClass::Name, "TerminalSubCategory", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FEdGraphTerminalType, TerminalSubCategory), METADATA_PARAMS(NewProp_TerminalSubCategory_MetaData, ARRAY_COUNT(NewProp_TerminalSubCategory_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_TerminalCategory = { UE4CodeGen_Private::EPropertyClass::Name, "TerminalCategory", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FEdGraphTerminalType, TerminalCategory), METADATA_PARAMS(NewProp_TerminalCategory_MetaData, ARRAY_COUNT(NewProp_TerminalCategory_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FEdGraphTerminalType_CRC() { return 3325659790U; }
