...
static struct FScriptStruct_Engine_StaticRegisterNativesFPassiveSoundMixModifier
{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_SoundMix = { UE4CodeGen_Private::EPropertyClass::Object, "SoundMix", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(FPassiveSoundMixModifier, SoundMix), Z_Construct_UClass_USoundMix_NoRegister, METADATA_PARAMS(NewProp_SoundMix_MetaData, ARRAY_COUNT(NewProp_SoundMix_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FPassiveSoundMixModifier_CRC() { return 3093147068U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundClassProperties
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSoundClassProperties()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_OutputTarget = { UE4CodeGen_Private::EPropertyClass::Byte, "OutputTarget", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(FSoundClassProperties, OutputTarget), Z_Construct_UEnum_Engine_EAudioOutputTarget, METADATA_PARAMS(NewProp_OutputTarget_MetaData, ARRAY_COUNT(NewProp_OutputTarget_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bApplyAmbientVolumes = { UE4CodeGen_Private::EPropertyClass::Bool, "bApplyAmbientVolumes", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundClassProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bApplyAmbientVolumes_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bApplyAmbientVolumes_MetaData, ARRAY_COUNT(NewProp_bApplyAmbientVolumes_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bReverb = { UE4CodeGen_Private::EPropertyClass::Bool, "bReverb", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundClassProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bReverb_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bReverb_MetaData, ARRAY_COUNT(NewProp_bReverb_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsMusic = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsMusic", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundClassProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsMusic_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsMusic_MetaData, ARRAY_COUNT(NewProp_bIsMusic_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsUISound = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsUISound", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundClassProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsUISound_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsUISound_MetaData, ARRAY_COUNT(NewProp_bIsUISound_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAlwaysPlay = { UE4CodeGen_Private::EPropertyClass::Bool, "bAlwaysPlay", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundClassProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bAlwaysPlay_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bAlwaysPlay_MetaData, ARRAY_COUNT(NewProp_bAlwaysPlay_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bApplyEffects = { UE4CodeGen_Private::EPropertyClass::Bool, "bApplyEffects", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSoundClassProperties), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bApplyEffects_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bApplyEffects_MetaData, ARRAY_COUNT(NewProp_bApplyEffects_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_RadioFilterVolumeThreshold = { UE4CodeGen_Private::EPropertyClass::Float, "RadioFilterVolumeThreshold", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(FSoundClassProperties, RadioFilterVolumeThreshold), METADATA_PARAMS(NewProp_RadioFilterVolumeThreshold_MetaData, ARRAY_COUNT(NewProp_RadioFilterVolumeThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_LFEBleed = { UE4CodeGen_Private::EPropertyClass::Float, "LFEBleed", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(FSoundClassProperties, LFEBleed), METADATA_PARAMS(NewProp_LFEBleed_MetaData, ARRAY_COUNT(NewProp_LFEBleed_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Pitch = { UE4CodeGen_Private::EPropertyClass::Float, "Pitch", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(FSoundClassProperties, Pitch), METADATA_PARAMS(NewProp_Pitch_MetaData, ARRAY_COUNT(NewProp_Pitch_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Volume = { UE4CodeGen_Private::EPropertyClass::Float, "Volume", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(FSoundClassProperties, Volume), METADATA_PARAMS(NewProp_Volume_MetaData, ARRAY_COUNT(NewProp_Volume_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FSoundClassProperties_CRC() { return 1190745225U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundClassEditorData
{
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PassiveSoundMixModifiers = { UE4CodeGen_Private::EPropertyClass::Array, "PassiveSoundMixModifiers", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USoundClass, PassiveSoundMixModifiers), METADATA_PARAMS(NewProp_PassiveSoundMixModifiers_MetaData, ARRAY_COUNT(NewProp_PassiveSoundMixModifiers_MetaData)) };
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_ChildClasses = { UE4CodeGen_Private::EPropertyClass::Array, "ChildClasses", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USoundClass, ChildClasses), METADATA_PARAMS(NewProp_ChildClasses_MetaData, ARRAY_COUNT(NewProp_ChildClasses_MetaData)) };
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_Properties = { UE4CodeGen_Private::EPropertyClass::Struct, "Properties", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(USoundClass, Properties), Z_Construct_UScriptStruct_FSoundClassProperties, METADATA_PARAMS(NewProp_Properties_MetaData, ARRAY_COUNT(NewProp_Properties_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	IMPLEMENT_CLASS(USoundClass, 1535324268);
