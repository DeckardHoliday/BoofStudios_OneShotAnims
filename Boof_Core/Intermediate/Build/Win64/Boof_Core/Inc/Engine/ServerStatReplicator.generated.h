...
private: \
	...
	friend ENGINE_API class UClass* Z_Construct_UClass_AServerStatReplicator(); \
public: \
	DECLARE_CLASS(AServerStatReplicator, AInfo, COMPILED_IN_FLAGS(0), 0, TEXT("/Script/Engine"), NO_API) \
