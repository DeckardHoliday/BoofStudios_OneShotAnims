...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_MapBuildDataId = { UE4CodeGen_Private::EPropertyClass::Struct, "MapBuildDataId", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(UReflectionCaptureComponent, MapBuildDataId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(NewProp_MapBuildDataId_MetaData, ARRAY_COUNT(NewProp_MapBuildDataId_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UReflectionCaptureComponent, 920420150);
