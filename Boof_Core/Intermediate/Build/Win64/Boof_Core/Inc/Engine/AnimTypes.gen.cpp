...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNotifyEvent
{
...
#endif
			auto NewProp_bTriggerOnFollower_SetBit = [](void* Obj){ ((FAnimNotifyEvent*)Obj)->bTriggerOnFollower = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bTriggerOnFollower = { UE4CodeGen_Private::EPropertyClass::Bool, "bTriggerOnFollower", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FAnimNotifyEvent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bTriggerOnFollower_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bTriggerOnFollower_MetaData, ARRAY_COUNT(NewProp_bTriggerOnFollower_MetaData)) };
#if WITH_METADATA
...
#endif // WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bTriggerOnFollower,
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNotifyEvent_CRC() { return 2261089919U; }
