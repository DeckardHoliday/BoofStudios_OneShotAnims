...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ESceneCapturePrimitiveRenderMode_CRC() { return 4291035507U; }
	UEnum* Z_Construct_UEnum_Engine_ESceneCapturePrimitiveRenderMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "PRM_LegacySceneCapture.DisplayName", "Legacy" },
...
static struct FScriptStruct_Engine_StaticRegisterNativesFEngineShowFlagsSetting
{
	...
	IMPLEMENT_CLASS(USceneCaptureComponent, 1897444777);
