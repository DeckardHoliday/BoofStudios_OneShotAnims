...
static struct FScriptStruct_Engine_StaticRegisterNativesFExposedValueHandler
{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Function = { UE4CodeGen_Private::EPropertyClass::Object, "Function", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FExposedValueHandler, Function), Z_Construct_UClass_UFunction, METADATA_PARAMS(NewProp_Function_MetaData, ARRAY_COUNT(NewProp_Function_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FExposedValueHandler_CRC() { return 162442252U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFExposedValueCopyRecord
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FExposedValueCopyRecord()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CachedSourceStructSubProperty = { UE4CodeGen_Private::EPropertyClass::Object, "CachedSourceStructSubProperty", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FExposedValueCopyRecord, CachedSourceStructSubProperty), Z_Construct_UClass_UProperty, METADATA_PARAMS(NewProp_CachedSourceStructSubProperty_MetaData, ARRAY_COUNT(NewProp_CachedSourceStructSubProperty_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CachedSourceProperty = { UE4CodeGen_Private::EPropertyClass::Object, "CachedSourceProperty", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FExposedValueCopyRecord, CachedSourceProperty), Z_Construct_UClass_UProperty, METADATA_PARAMS(NewProp_CachedSourceProperty_MetaData, ARRAY_COUNT(NewProp_CachedSourceProperty_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CachedSourceStructSubProperty,
	...
	uint32 Get_Z_Construct_UScriptStruct_FExposedValueCopyRecord_CRC() { return 3471017013U; }
