...
static struct FScriptStruct_Engine_StaticRegisterNativesFStreamedAudioPlatformData
{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_InternalCurves = { UE4CodeGen_Private::EPropertyClass::Object, "InternalCurves", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000000, 1, nullptr, STRUCT_OFFSET(USoundWave, InternalCurves), Z_Construct_UClass_UCurveTable_NoRegister, METADATA_PARAMS(NewProp_InternalCurves_MetaData, ARRAY_COUNT(NewProp_InternalCurves_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Curves = { UE4CodeGen_Private::EPropertyClass::Object, "Curves", RF_Public|RF_Transient|RF_MarkAsNative, 0x00200c0000000001, 1, nullptr, STRUCT_OFFSET(USoundWave, Curves), Z_Construct_UClass_UCurveTable_NoRegister, METADATA_PARAMS(NewProp_Curves_MetaData, ARRAY_COUNT(NewProp_Curves_MetaData)) };
...
#endif
			auto NewProp_bIsAmbisonics_SetBit = [](void* Obj){ ((USoundWave*)Obj)->bIsAmbisonics = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsAmbisonics = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsAmbisonics", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(USoundWave), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsAmbisonics_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsAmbisonics_MetaData, ARRAY_COUNT(NewProp_bIsAmbisonics_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USoundWave, 2276380394);
