...
static struct FScriptStruct_Engine_StaticRegisterNativesFSkeletalMeshLODInfo
{
...
#endif
			auto NewProp_bSupportUniformlyDistributedSampling_SetBit = [](void* Obj){ ((FSkeletalMeshLODInfo*)Obj)->bSupportUniformlyDistributedSampling = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSupportUniformlyDistributedSampling = { UE4CodeGen_Private::EPropertyClass::Bool, "bSupportUniformlyDistributedSampling", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010040000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSkeletalMeshLODInfo), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSupportUniformlyDistributedSampling_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSupportUniformlyDistributedSampling_MetaData, ARRAY_COUNT(NewProp_bSupportUniformlyDistributedSampling_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bAllowCPUAccess_SetBit = [](void* Obj){ ((FSkeletalMeshLODInfo*)Obj)->bAllowCPUAccess = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAllowCPUAccess = { UE4CodeGen_Private::EPropertyClass::Bool, "bAllowCPUAccess", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(FSkeletalMeshLODInfo), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bAllowCPUAccess_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bAllowCPUAccess_MetaData, ARRAY_COUNT(NewProp_bAllowCPUAccess_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FSkeletalMeshLODInfo_CRC() { return 1393520543U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBoneMirrorInfo
{
	...
	UClass* Z_Construct_UClass_USkeletalMesh()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SamplingInfo = { UE4CodeGen_Private::EPropertyClass::Struct, "SamplingInfo", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000001, 1, nullptr, STRUCT_OFFSET(USkeletalMesh, SamplingInfo), Z_Construct_UScriptStruct_FSkeletalMeshSamplingInfo, METADATA_PARAMS(NewProp_SamplingInfo_MetaData, ARRAY_COUNT(NewProp_SamplingInfo_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SamplingInfo,
	...
	IMPLEMENT_CLASS(USkeletalMesh, 725492309);
