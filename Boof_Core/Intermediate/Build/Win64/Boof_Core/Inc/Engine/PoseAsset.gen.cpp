...
static struct FScriptStruct_Engine_StaticRegisterNativesFPoseData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FPoseData()
	{
		...
		if (!ReturnStruct)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LocalSpacePoseMask_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Animation/PoseAsset.h" },
				{ "ToolTip", "whether or not, the joint contains delta transform from base pose\nit only blends if this is true\nthis allows per bone blend" },
			};
#endif
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_SourceCurveData = { UE4CodeGen_Private::EPropertyClass::Array, "SourceCurveData", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000800000000, 1, nullptr, STRUCT_OFFSET(FPoseData, SourceCurveData), METADATA_PARAMS(NewProp_SourceCurveData_MetaData, ARRAY_COUNT(NewProp_SourceCurveData_MetaData)) };
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SourceCurveData_Inner = { UE4CodeGen_Private::EPropertyClass::Float, "SourceCurveData", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800000000, 1, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_SourceLocalSpacePose = { UE4CodeGen_Private::EPropertyClass::Array, "SourceLocalSpacePose", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000800000000, 1, nullptr, STRUCT_OFFSET(FPoseData, SourceLocalSpacePose), METADATA_PARAMS(NewProp_SourceLocalSpacePose_MetaData, ARRAY_COUNT(NewProp_SourceLocalSpacePose_MetaData)) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_SourceLocalSpacePose_Inner = { UE4CodeGen_Private::EPropertyClass::Struct, "SourceLocalSpacePose", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800000000, 1, nullptr, 0, Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SourceCurveData,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SourceCurveData_Inner,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SourceLocalSpacePose,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SourceLocalSpacePose_Inner,
#endif // WITH_EDITORONLY_DATA
			};
			static const UE4CodeGen_Private::FStructParams ReturnStructParams = {
				(UObject* (*)())Z_Construct_UPackage__Script_Engine,
	...
	uint32 Get_Z_Construct_UScriptStruct_FPoseData_CRC() { return 2613744098U; }
