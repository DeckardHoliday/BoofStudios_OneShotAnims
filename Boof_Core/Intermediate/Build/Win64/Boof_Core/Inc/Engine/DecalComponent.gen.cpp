...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_DecalMaterial = { UE4CodeGen_Private::EPropertyClass::Object, "DecalMaterial", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000015, 1, nullptr, STRUCT_OFFSET(UDecalComponent, DecalMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(NewProp_DecalMaterial_MetaData, ARRAY_COUNT(NewProp_DecalMaterial_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	IMPLEMENT_CLASS(UDecalComponent, 2727075130);
