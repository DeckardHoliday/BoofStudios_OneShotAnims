...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UTexture2D()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsStreamable = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsStreamable", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000400002000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UTexture2D), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsStreamable_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsStreamable_MetaData, ARRAY_COUNT(NewProp_bIsStreamable_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bTemporarilyDisableStreaming = { UE4CodeGen_Private::EPropertyClass::Bool, "bTemporarilyDisableStreaming", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000002000, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UTexture2D), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bTemporarilyDisableStreaming_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bTemporarilyDisableStreaming_MetaData, ARRAY_COUNT(NewProp_bTemporarilyDisableStreaming_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTexture2D, 73571534);
