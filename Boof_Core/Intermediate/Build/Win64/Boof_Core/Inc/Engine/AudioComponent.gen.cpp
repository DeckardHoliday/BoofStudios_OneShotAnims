...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_NumWaveInstances = { UE4CodeGen_Private::EPropertyClass::Int, "NumWaveInstances", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_Engine_eventOnAudioMultiEnvelopeValue_Parms, NumWaveInstances), METADATA_PARAMS(NewProp_NumWaveInstances_MetaData, ARRAY_COUNT(NewProp_NumWaveInstances_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MaxEnvelope_MetaData[] = {
				{ "NativeConst", "" },
			};
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_MaxEnvelope = { UE4CodeGen_Private::EPropertyClass::Float, "MaxEnvelope", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_Engine_eventOnAudioMultiEnvelopeValue_Parms, MaxEnvelope), METADATA_PARAMS(NewProp_MaxEnvelope_MetaData, ARRAY_COUNT(NewProp_MaxEnvelope_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AverageEnvelopeValue_MetaData[] = {
				{ "NativeConst", "" },
			};
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AverageEnvelopeValue = { UE4CodeGen_Private::EPropertyClass::Float, "AverageEnvelopeValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_Engine_eventOnAudioMultiEnvelopeValue_Parms, AverageEnvelopeValue), METADATA_PARAMS(NewProp_AverageEnvelopeValue_MetaData, ARRAY_COUNT(NewProp_AverageEnvelopeValue_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_NumWaveInstances,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_MaxEnvelope,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_AverageEnvelopeValue,
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, "OnAudioMultiEnvelopeValue__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00130000, sizeof(_Script_Engine_eventOnAudioMultiEnvelopeValue_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_EnvelopeValue = { UE4CodeGen_Private::EPropertyClass::Float, "EnvelopeValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_Engine_eventOnAudioSingleEnvelopeValue_Parms, EnvelopeValue), METADATA_PARAMS(NewProp_EnvelopeValue_MetaData, ARRAY_COUNT(NewProp_EnvelopeValue_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PlayingSoundWave_MetaData[] = {
				{ "NativeConst", "" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PlayingSoundWave = { UE4CodeGen_Private::EPropertyClass::Object, "PlayingSoundWave", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000082, 1, nullptr, STRUCT_OFFSET(_Script_Engine_eventOnAudioSingleEnvelopeValue_Parms, PlayingSoundWave), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(NewProp_PlayingSoundWave_MetaData, ARRAY_COUNT(NewProp_PlayingSoundWave_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_EnvelopeValue,
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, "OnAudioSingleEnvelopeValue__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00130000, sizeof(_Script_Engine_eventOnAudioSingleEnvelopeValue_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioComponentParam
{
	...
	UClass* Z_Construct_UClass_UAudioComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UAudioComponent_BP_GetAttenuationSettingsToApply, "BP_GetAttenuationSettingsToApply" }, // 2187397564
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_AutoAttachRotationRule = { UE4CodeGen_Private::EPropertyClass::Enum, "AutoAttachRotationRule", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UAudioComponent, AutoAttachRotationRule), Z_Construct_UEnum_Engine_EAttachmentRule, METADATA_PARAMS(NewProp_AutoAttachRotationRule_MetaData, ARRAY_COUNT(NewProp_AutoAttachRotationRule_MetaData)) };
...
#endif
			auto NewProp_bAutoManageAttachment_SetBit = [](void* Obj){ ((UAudioComponent*)Obj)->bAutoManageAttachment = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAutoManageAttachment = { UE4CodeGen_Private::EPropertyClass::Bool, "bAutoManageAttachment", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(uint8), UE4CodeGen_Private::ENativeBool::NotNative, sizeof(UAudioComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bAutoManageAttachment_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bAutoManageAttachment_MetaData, ARRAY_COUNT(NewProp_bAutoManageAttachment_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnAudioMultiEnvelopeValue = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnAudioMultiEnvelopeValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000010080000, 1, nullptr, STRUCT_OFFSET(UAudioComponent, OnAudioMultiEnvelopeValue), Z_Construct_UDelegateFunction_Engine_OnAudioMultiEnvelopeValue__DelegateSignature, METADATA_PARAMS(NewProp_OnAudioMultiEnvelopeValue_MetaData, ARRAY_COUNT(NewProp_OnAudioMultiEnvelopeValue_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnAudioSingleEnvelopeValue_MetaData[] = {
				{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
			};
#endif
			static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnAudioSingleEnvelopeValue = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnAudioSingleEnvelopeValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000010080000, 1, nullptr, STRUCT_OFFSET(UAudioComponent, OnAudioSingleEnvelopeValue), Z_Construct_UDelegateFunction_Engine_OnAudioSingleEnvelopeValue__DelegateSignature, METADATA_PARAMS(NewProp_OnAudioSingleEnvelopeValue_MetaData, ARRAY_COUNT(NewProp_OnAudioSingleEnvelopeValue_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_EnvelopeFollowerReleaseTime = { UE4CodeGen_Private::EPropertyClass::Int, "EnvelopeFollowerReleaseTime", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UAudioComponent, EnvelopeFollowerReleaseTime), METADATA_PARAMS(NewProp_EnvelopeFollowerReleaseTime_MetaData, ARRAY_COUNT(NewProp_EnvelopeFollowerReleaseTime_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_EnvelopeFollowerAttackTime = { UE4CodeGen_Private::EPropertyClass::Int, "EnvelopeFollowerAttackTime", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UAudioComponent, EnvelopeFollowerAttackTime), METADATA_PARAMS(NewProp_EnvelopeFollowerAttackTime_MetaData, ARRAY_COUNT(NewProp_EnvelopeFollowerAttackTime_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_OnAudioMultiEnvelopeValue,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_OnAudioSingleEnvelopeValue,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_EnvelopeFollowerReleaseTime,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_EnvelopeFollowerAttackTime,
	...
	IMPLEMENT_CLASS(UAudioComponent, 1773344413);
