...
static struct FScriptStruct_Engine_StaticRegisterNativesFTableRowBase
{
	...
	UClass* Z_Construct_UClass_UDataTable()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FSetPropertyParams NewProp_TemporarilyReferencedObjects = { UE4CodeGen_Private::EPropertyClass::Set, "TemporarilyReferencedObjects", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000800002000, 1, nullptr, STRUCT_OFFSET(UDataTable, TemporarilyReferencedObjects), METADATA_PARAMS(NewProp_TemporarilyReferencedObjects_MetaData, ARRAY_COUNT(NewProp_TemporarilyReferencedObjects_MetaData)) };
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_TemporarilyReferencedObjects_ElementProp = { UE4CodeGen_Private::EPropertyClass::Object, "TemporarilyReferencedObjects", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800000000, 1, nullptr, 0, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_RowsSerializedWithTags = { UE4CodeGen_Private::EPropertyClass::Array, "RowsSerializedWithTags", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000800002000, 1, nullptr, STRUCT_OFFSET(UDataTable, RowsSerializedWithTags), METADATA_PARAMS(NewProp_RowsSerializedWithTags_MetaData, ARRAY_COUNT(NewProp_RowsSerializedWithTags_MetaData)) };
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_RowsSerializedWithTags_Inner = { UE4CodeGen_Private::EPropertyClass::Byte, "RowsSerializedWithTags", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000800000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			auto NewProp_bStripFromClientBuilds_SetBit = [](void* Obj){ ((UDataTable*)Obj)->bStripFromClientBuilds = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bStripFromClientBuilds = { UE4CodeGen_Private::EPropertyClass::Bool, "bStripFromClientBuilds", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UDataTable), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bStripFromClientBuilds_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bStripFromClientBuilds_MetaData, ARRAY_COUNT(NewProp_bStripFromClientBuilds_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
#if WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_TemporarilyReferencedObjects,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_TemporarilyReferencedObjects_ElementProp,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_RowsSerializedWithTags,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_RowsSerializedWithTags_Inner,
...
#endif // WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bStripFromClientBuilds,
	...
	IMPLEMENT_CLASS(UDataTable, 4223427110);
