...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_APlayerState_GetPlayerName()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_ReturnValue = { UE4CodeGen_Private::EPropertyClass::Str, "ReturnValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000580, 1, nullptr, STRUCT_OFFSET(PlayerState_eventGetPlayerName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_APlayerState, "GetPlayerName", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x54020401, sizeof(PlayerState_eventGetPlayerName_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_APlayerState, "OnRep_PlayerId", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00020400, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_APlayerState()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_APlayerState_GetPlayerName, "GetPlayerName" }, // 375322196
				{ &Z_Construct_UFunction_APlayerState_OnRep_bIsInactive, "OnRep_bIsInactive" }, // 1273242079
				{ &Z_Construct_UFunction_APlayerState_OnRep_PlayerId, "OnRep_PlayerId" }, // 3351318799
...
#endif
			auto NewProp_bShouldUpdateReplicatedPing_SetBit = [](void* Obj){ ((APlayerState*)Obj)->bShouldUpdateReplicatedPing = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bShouldUpdateReplicatedPing = { UE4CodeGen_Private::EPropertyClass::Bool, "bShouldUpdateReplicatedPing", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000010001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(APlayerState), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bShouldUpdateReplicatedPing_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bShouldUpdateReplicatedPing_MetaData, ARRAY_COUNT(NewProp_bShouldUpdateReplicatedPing_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_PlayerNamePrivate = { UE4CodeGen_Private::EPropertyClass::Str, "PlayerNamePrivate", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000100000020, 1, "OnRep_PlayerName", STRUCT_OFFSET(APlayerState, PlayerNamePrivate), METADATA_PARAMS(NewProp_PlayerNamePrivate_MetaData, ARRAY_COUNT(NewProp_PlayerNamePrivate_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FIntPropertyParams NewProp_PlayerId = { UE4CodeGen_Private::EPropertyClass::Int, "PlayerId", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000100000034, 1, "OnRep_PlayerId", STRUCT_OFFSET(APlayerState, PlayerId), METADATA_PARAMS(NewProp_PlayerId_MetaData, ARRAY_COUNT(NewProp_PlayerId_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_PlayerName = { UE4CodeGen_Private::EPropertyClass::Str, "PlayerName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000014, 1, nullptr, STRUCT_OFFSET(APlayerState, PlayerName), METADATA_PARAMS(NewProp_PlayerName_MetaData, ARRAY_COUNT(NewProp_PlayerName_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bShouldUpdateReplicatedPing,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PlayerNamePrivate,
	...
	IMPLEMENT_CLASS(APlayerState, 1053786753);
