...
static struct FScriptStruct_LevelSequence_StaticRegisterNativesFBoundActorProxy
{
	...
	UClass* Z_Construct_UClass_ALevelSequenceActor()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_DefaultInstanceData = { UE4CodeGen_Private::EPropertyClass::Object, "DefaultInstanceData", RF_Public|RF_Transient|RF_MarkAsNative, 0x001200000008000c, 1, nullptr, STRUCT_OFFSET(ALevelSequenceActor, DefaultInstanceData), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(NewProp_DefaultInstanceData_MetaData, ARRAY_COUNT(NewProp_DefaultInstanceData_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bOverrideInstanceData_SetBit = [](void* Obj){ ((ALevelSequenceActor*)Obj)->bOverrideInstanceData = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bOverrideInstanceData = { UE4CodeGen_Private::EPropertyClass::Bool, "bOverrideInstanceData", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(ALevelSequenceActor), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bOverrideInstanceData_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bOverrideInstanceData_MetaData, ARRAY_COUNT(NewProp_bOverrideInstanceData_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_BindingOverrides = { UE4CodeGen_Private::EPropertyClass::Object, "BindingOverrides", RF_Public|RF_Transient|RF_MarkAsNative, 0x001200000008001c, 1, nullptr, STRUCT_OFFSET(ALevelSequenceActor, BindingOverrides), Z_Construct_UClass_UMovieSceneBindingOverrides_NoRegister, METADATA_PARAMS(NewProp_BindingOverrides_MetaData, ARRAY_COUNT(NewProp_BindingOverrides_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_BurnInOptions = { UE4CodeGen_Private::EPropertyClass::Object, "BurnInOptions", RF_Public|RF_Transient|RF_MarkAsNative, 0x001200000008001c, 1, nullptr, STRUCT_OFFSET(ALevelSequenceActor, BurnInOptions), Z_Construct_UClass_ULevelSequenceBurnInOptions_NoRegister, METADATA_PARAMS(NewProp_BurnInOptions_MetaData, ARRAY_COUNT(NewProp_BurnInOptions_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FArrayPropertyParams NewProp_AdditionalEventReceivers = { UE4CodeGen_Private::EPropertyClass::Array, "AdditionalEventReceivers", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000015, 1, nullptr, STRUCT_OFFSET(ALevelSequenceActor, AdditionalEventReceivers), METADATA_PARAMS(NewProp_AdditionalEventReceivers_MetaData, ARRAY_COUNT(NewProp_AdditionalEventReceivers_MetaData)) };
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_DefaultInstanceData,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bOverrideInstanceData,
	...
	IMPLEMENT_CLASS(ALevelSequenceActor, 3221250400);
