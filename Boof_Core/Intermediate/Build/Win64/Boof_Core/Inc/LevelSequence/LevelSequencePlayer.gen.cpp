...
static struct FScriptStruct_LevelSequence_StaticRegisterNativesFLevelSequencePlayerSnapshot
{
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_CurrentShotName = { UE4CodeGen_Private::EPropertyClass::Str, "CurrentShotName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020015, 1, nullptr, STRUCT_OFFSET(FLevelSequencePlayerSnapshot, CurrentShotName), METADATA_PARAMS(NewProp_CurrentShotName_MetaData, ARRAY_COUNT(NewProp_CurrentShotName_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_MasterName = { UE4CodeGen_Private::EPropertyClass::Str, "MasterName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000020015, 1, nullptr, STRUCT_OFFSET(FLevelSequencePlayerSnapshot, MasterName), METADATA_PARAMS(NewProp_MasterName_MetaData, ARRAY_COUNT(NewProp_MasterName_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FLevelSequencePlayerSnapshot_CRC() { return 1429121625U; }
...
static struct FScriptStruct_LevelSequence_StaticRegisterNativesFLevelSequenceSnapshotSettings
{
	...
	IMPLEMENT_CLASS(ULevelSequencePlayer, 1571229513);
