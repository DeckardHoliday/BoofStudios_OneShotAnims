...
#define Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayFunctionLibrary_h_15_RPC_WRAPPERS \
 \
	DECLARE_FUNCTION(execAddDeviceVisualizationComponent) \
	{ \
		...
		P_FINISH; \
		P_NATIVE_BEGIN; \
		*(UPrimitiveComponent**)Z_Param__Result=UHeadMountedDisplayFunctionLibrary::AddDeviceVisualizationComponent(Z_Param_Target,Z_Param_Out_XRDeviceId,Z_Param_bManualAttachment,Z_Param_Out_RelativeTransform); \
		P_NATIVE_END; \
	} \
 \
