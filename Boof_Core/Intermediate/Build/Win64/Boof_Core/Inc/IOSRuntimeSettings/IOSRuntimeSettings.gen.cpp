...
static struct FScriptStruct_IOSRuntimeSettings_StaticRegisterNativesFIOSBuildResourceFilePath
{
	...
	UClass* Z_Construct_UClass_UIOSRuntimeSettings()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bDisableHTTPS_SetBit = [](void* Obj){ ((UIOSRuntimeSettings*)Obj)->bDisableHTTPS = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDisableHTTPS = { UE4CodeGen_Private::EPropertyClass::Bool, "bDisableHTTPS", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000044001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UIOSRuntimeSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bDisableHTTPS_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bDisableHTTPS_MetaData, ARRAY_COUNT(NewProp_bDisableHTTPS_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_IOSTeamID = { UE4CodeGen_Private::EPropertyClass::Str, "IOSTeamID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000044001, 1, nullptr, STRUCT_OFFSET(UIOSRuntimeSettings, IOSTeamID), METADATA_PARAMS(NewProp_IOSTeamID_MetaData, ARRAY_COUNT(NewProp_IOSTeamID_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bGenerateCrashReportSymbols_SetBit = [](void* Obj){ ((UIOSRuntimeSettings*)Obj)->bGenerateCrashReportSymbols = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bGenerateCrashReportSymbols = { UE4CodeGen_Private::EPropertyClass::Bool, "bGenerateCrashReportSymbols", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000044001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UIOSRuntimeSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bGenerateCrashReportSymbols_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bGenerateCrashReportSymbols_MetaData, ARRAY_COUNT(NewProp_bGenerateCrashReportSymbols_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bDisableHTTPS,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_IOSTeamID,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bGenerateCrashReportSymbols,
	...
	IMPLEMENT_CLASS(UIOSRuntimeSettings, 3388287804);
