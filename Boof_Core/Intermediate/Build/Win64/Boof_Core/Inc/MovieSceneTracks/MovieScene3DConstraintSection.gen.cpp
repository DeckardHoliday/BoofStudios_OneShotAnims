...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_ConstraintBindingID = { UE4CodeGen_Private::EPropertyClass::Struct, "ConstraintBindingID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000000001, 1, nullptr, STRUCT_OFFSET(UMovieScene3DConstraintSection, ConstraintBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(NewProp_ConstraintBindingID_MetaData, ARRAY_COUNT(NewProp_ConstraintBindingID_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_ConstraintId = { UE4CodeGen_Private::EPropertyClass::Struct, "ConstraintId", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080020000000, 1, nullptr, STRUCT_OFFSET(UMovieScene3DConstraintSection, ConstraintId_DEPRECATED), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(NewProp_ConstraintId_MetaData, ARRAY_COUNT(NewProp_ConstraintId_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ConstraintBindingID,
	...
	IMPLEMENT_CLASS(UMovieScene3DConstraintSection, 3987302442);
