...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMovieSceneCinematicShotSection()
	{
		...
		if (!OuterClass)
		{
...
#endif
			static const UE4CodeGen_Private::FTextPropertyParams NewProp_DisplayName = { UE4CodeGen_Private::EPropertyClass::Text, "DisplayName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000020000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneCinematicShotSection, DisplayName_DEPRECATED), METADATA_PARAMS(NewProp_DisplayName_MetaData, ARRAY_COUNT(NewProp_DisplayName_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStrPropertyParams NewProp_ShotDisplayName = { UE4CodeGen_Private::EPropertyClass::Str, "ShotDisplayName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneCinematicShotSection, ShotDisplayName), METADATA_PARAMS(NewProp_ShotDisplayName_MetaData, ARRAY_COUNT(NewProp_ShotDisplayName_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ShotDisplayName,
			};
	...
	IMPLEMENT_CLASS(UMovieSceneCinematicShotSection, 4248786321);
