...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DPathSectionTemplate
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieScene3DPathSectionTemplate()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_PathBindingID = { UE4CodeGen_Private::EPropertyClass::Struct, "PathBindingID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieScene3DPathSectionTemplate, PathBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(NewProp_PathBindingID_MetaData, ARRAY_COUNT(NewProp_PathBindingID_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_PathBindingID,
			};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DPathSectionTemplate_CRC() { return 1404255580U; }
