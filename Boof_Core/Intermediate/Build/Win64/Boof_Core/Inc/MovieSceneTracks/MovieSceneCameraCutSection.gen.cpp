...
// End Cross Module References
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_CameraBindingID = { UE4CodeGen_Private::EPropertyClass::Struct, "CameraBindingID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(UMovieSceneCameraCutSection, CameraBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(NewProp_CameraBindingID_MetaData, ARRAY_COUNT(NewProp_CameraBindingID_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_CameraGuid = { UE4CodeGen_Private::EPropertyClass::Struct, "CameraGuid", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000020000000, 1, nullptr, STRUCT_OFFSET(UMovieSceneCameraCutSection, CameraGuid_DEPRECATED), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(NewProp_CameraGuid_MetaData, ARRAY_COUNT(NewProp_CameraGuid_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
#if WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ThumbnailReferenceOffset,
#endif // WITH_EDITORONLY_DATA
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_CameraBindingID,
	...
	IMPLEMENT_CLASS(UMovieSceneCameraCutSection, 2722338214);
