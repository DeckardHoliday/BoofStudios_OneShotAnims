...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DAttachSectionTemplate
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieScene3DAttachSectionTemplate()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_AttachBindingID = { UE4CodeGen_Private::EPropertyClass::Struct, "AttachBindingID", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000000, 1, nullptr, STRUCT_OFFSET(FMovieScene3DAttachSectionTemplate, AttachBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(NewProp_AttachBindingID_MetaData, ARRAY_COUNT(NewProp_AttachBindingID_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_AttachBindingID,
			};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DAttachSectionTemplate_CRC() { return 975550053U; }
