...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UGeneralProjectSettings()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bSupportAR_MetaData[] = {
				{ "Category", "Settings" },
				{ "ModuleRelativePath", "Classes/GeneralProjectSettings.h" },
				{ "ToolTip", "Will this app support Augmented Reality (AR) in some capacity?" },
			};
#endif
			auto NewProp_bSupportAR_SetBit = [](void* Obj){ ((UGeneralProjectSettings*)Obj)->bSupportAR = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSupportAR = { UE4CodeGen_Private::EPropertyClass::Bool, "bSupportAR", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000004001, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UGeneralProjectSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSupportAR_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSupportAR_MetaData, ARRAY_COUNT(NewProp_bSupportAR_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bStartInAR_MetaData[] = {
				{ "ModuleRelativePath", "Classes/GeneralProjectSettings.h" },
				{ "ToolTip", "This field is no longer used; @see FARSystemBase::StartARSession(); @see UARBlueprintLibrary::StartARSession()" },
			};
#endif
			auto NewProp_bStartInAR_SetBit = [](void* Obj){ ((UGeneralProjectSettings*)Obj)->bStartInAR_DEPRECATED = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bStartInAR = { UE4CodeGen_Private::EPropertyClass::Bool, "bStartInAR", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000020000000, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UGeneralProjectSettings), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bStartInAR_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bStartInAR_MetaData, ARRAY_COUNT(NewProp_bStartInAR_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSupportAR,
	...
	IMPLEMENT_CLASS(UGeneralProjectSettings, 2143057718);
